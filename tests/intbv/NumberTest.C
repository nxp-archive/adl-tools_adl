// WARNING: THIS FILE IS AUTOGENERATED BY callTemplatizer.pl DO NOT EDIT.  
// EDIT ./NumberTest.C.in INSTEAD!!! 
//
...
{   
  ...
  // P: 1,64  // comment out t.checkConcatenation<1,32,64,128,10,31,33,100>() if you scale down here
  ...
  rc |= t.checkConstructors <1,1>();
  rc |= t.checkConstructors <1,32>();
  rc |= t.checkConstructors <1,64>();
  rc |= t.checkConstructors <1,128>();
  rc |= t.checkConstructors <1,10>();
  rc |= t.checkConstructors <1,31>();
  rc |= t.checkConstructors <1,33>();
  rc |= t.checkConstructors <1,100>();
  rc |= t.checkConstructors <32,32>();
  rc |= t.checkConstructors <32,64>();
  rc |= t.checkConstructors <32,128>();
  rc |= t.checkConstructors <10,32>();
  rc |= t.checkConstructors <31,32>();
  rc |= t.checkConstructors <32,33>();
  rc |= t.checkConstructors <32,100>();
  rc |= t.checkConstructors <64,64>();
  rc |= t.checkConstructors <64,128>();
  rc |= t.checkConstructors <10,64>();
  rc |= t.checkConstructors <31,64>();
  rc |= t.checkConstructors <33,64>();
  rc |= t.checkConstructors <64,100>();
  rc |= t.checkConstructors <128,128>();
  rc |= t.checkConstructors <10,128>();
  rc |= t.checkConstructors <31,128>();
  rc |= t.checkConstructors <33,128>();
  rc |= t.checkConstructors <100,128>();
  rc |= t.checkConstructors <10,10>();
  rc |= t.checkConstructors <10,31>();
  rc |= t.checkConstructors <10,33>();
  rc |= t.checkConstructors <10,100>();
  rc |= t.checkConstructors <31,31>();
  rc |= t.checkConstructors <31,33>();
  rc |= t.checkConstructors <31,100>();
  rc |= t.checkConstructors <33,33>();
  rc |= t.checkConstructors <33,100>();
  rc |= t.checkConstructors <100,100>();
  ...
  rc |= t.checkPopCounts <1>();
  rc |= t.checkPopCounts <32>();
  rc |= t.checkPopCounts <64>();
  rc |= t.checkPopCounts <128>();
  rc |= t.checkPopCounts <10>();
  rc |= t.checkPopCounts <31>();
  rc |= t.checkPopCounts <33>();
  rc |= t.checkPopCounts <100>();

  // check count-leading-zeros
  cout<<"Starting count-leading-zeros..."<<endl;
  rc |= t.checkCountLeadingZeros <1>();
  rc |= t.checkCountLeadingZeros <32>();
  rc |= t.checkCountLeadingZeros <64>();
  rc |= t.checkCountLeadingZeros <128>();
  rc |= t.checkCountLeadingZeros <10>();
  rc |= t.checkCountLeadingZeros <31>();
  rc |= t.checkCountLeadingZeros <33>();
  rc |= t.checkCountLeadingZeros <100>();

  // concatenation
  cout<<"Starting concatenation..."<<endl;
  rc |= t.checkConcatenation <1,32,64,128,10,31,33,100>();
                                                                                                                                      
  // add
  cout<<"Starting adds..."<<endl;
  rc |= t.checkOperator <1,1>( "+", &calc);
  rc |= t.checkOperator <1,32>( "+", &calc);
  rc |= t.checkOperator <1,64>( "+", &calc);
  rc |= t.checkOperator <1,128>( "+", &calc);
  rc |= t.checkOperator <1,10>( "+", &calc);
  rc |= t.checkOperator <1,31>( "+", &calc);
  rc |= t.checkOperator <1,33>( "+", &calc);
  rc |= t.checkOperator <1,100>( "+", &calc);
  rc |= t.checkOperator <32,32>( "+", &calc);
  rc |= t.checkOperator <32,64>( "+", &calc);
  rc |= t.checkOperator <32,128>( "+", &calc);
  rc |= t.checkOperator <10,32>( "+", &calc);
  rc |= t.checkOperator <31,32>( "+", &calc);
  rc |= t.checkOperator <32,33>( "+", &calc);
  rc |= t.checkOperator <32,100>( "+", &calc);
  rc |= t.checkOperator <64,64>( "+", &calc);
  rc |= t.checkOperator <64,128>( "+", &calc);
  rc |= t.checkOperator <10,64>( "+", &calc);
  rc |= t.checkOperator <31,64>( "+", &calc);
  rc |= t.checkOperator <33,64>( "+", &calc);
  rc |= t.checkOperator <64,100>( "+", &calc);
  rc |= t.checkOperator <128,128>( "+", &calc);
  rc |= t.checkOperator <10,128>( "+", &calc);
  rc |= t.checkOperator <31,128>( "+", &calc);
  rc |= t.checkOperator <33,128>( "+", &calc);
  rc |= t.checkOperator <100,128>( "+", &calc);
  rc |= t.checkOperator <10,10>( "+", &calc);
  rc |= t.checkOperator <10,31>( "+", &calc);
  rc |= t.checkOperator <10,33>( "+", &calc);
  rc |= t.checkOperator <10,100>( "+", &calc);
  rc |= t.checkOperator <31,31>( "+", &calc);
  rc |= t.checkOperator <31,33>( "+", &calc);
  rc |= t.checkOperator <31,100>( "+", &calc);
  rc |= t.checkOperator <33,33>( "+", &calc);
  rc |= t.checkOperator <33,100>( "+", &calc);
  rc |= t.checkOperator <100,100>( "+", &calc);
  rc |= t.checkMutator <1,1>( "+=", &calc);
  rc |= t.checkMutator <1,32>( "+=", &calc);
  rc |= t.checkMutator <1,64>( "+=", &calc);
  rc |= t.checkMutator <1,128>( "+=", &calc);
  rc |= t.checkMutator <1,10>( "+=", &calc);
  rc |= t.checkMutator <1,31>( "+=", &calc);
  rc |= t.checkMutator <1,33>( "+=", &calc);
  rc |= t.checkMutator <1,100>( "+=", &calc);
  rc |= t.checkMutator <32,32>( "+=", &calc);
  rc |= t.checkMutator <32,64>( "+=", &calc);
  rc |= t.checkMutator <32,128>( "+=", &calc);
  rc |= t.checkMutator <10,32>( "+=", &calc);
  rc |= t.checkMutator <31,32>( "+=", &calc);
  rc |= t.checkMutator <32,33>( "+=", &calc);
  rc |= t.checkMutator <32,100>( "+=", &calc);
  rc |= t.checkMutator <64,64>( "+=", &calc);
  rc |= t.checkMutator <64,128>( "+=", &calc);
  rc |= t.checkMutator <10,64>( "+=", &calc);
  rc |= t.checkMutator <31,64>( "+=", &calc);
  rc |= t.checkMutator <33,64>( "+=", &calc);
  rc |= t.checkMutator <64,100>( "+=", &calc);
  rc |= t.checkMutator <128,128>( "+=", &calc);
  rc |= t.checkMutator <10,128>( "+=", &calc);
  rc |= t.checkMutator <31,128>( "+=", &calc);
  rc |= t.checkMutator <33,128>( "+=", &calc);
  rc |= t.checkMutator <100,128>( "+=", &calc);
  rc |= t.checkMutator <10,10>( "+=", &calc);
  rc |= t.checkMutator <10,31>( "+=", &calc);
  rc |= t.checkMutator <10,33>( "+=", &calc);
  rc |= t.checkMutator <10,100>( "+=", &calc);
  rc |= t.checkMutator <31,31>( "+=", &calc);
  rc |= t.checkMutator <31,33>( "+=", &calc);
  rc |= t.checkMutator <31,100>( "+=", &calc);
  rc |= t.checkMutator <33,33>( "+=", &calc);
  rc |= t.checkMutator <33,100>( "+=", &calc);
  rc |= t.checkMutator <100,100>( "+=", &calc);
  ...
  if(!SIGNED) { 
    ...
    rc |= t.checkOperator <1,1>("*",&calc,true);
    rc |= t.checkOperator <1,32>("*",&calc,true);
    rc |= t.checkOperator <1,64>("*",&calc,true);
    rc |= t.checkOperator <1,128>("*",&calc,true);
    rc |= t.checkOperator <1,10>("*",&calc,true);
    rc |= t.checkOperator <1,31>("*",&calc,true);
    rc |= t.checkOperator <1,33>("*",&calc,true);
    rc |= t.checkOperator <1,100>("*",&calc,true);
    rc |= t.checkOperator <32,32>("*",&calc,true);
    rc |= t.checkOperator <32,64>("*",&calc,true);
    rc |= t.checkOperator <32,128>("*",&calc,true);
    rc |= t.checkOperator <10,32>("*",&calc,true);
    rc |= t.checkOperator <31,32>("*",&calc,true);
    rc |= t.checkOperator <32,33>("*",&calc,true);
    rc |= t.checkOperator <32,100>("*",&calc,true);
    rc |= t.checkOperator <64,64>("*",&calc,true);
    rc |= t.checkOperator <64,128>("*",&calc,true);
    rc |= t.checkOperator <10,64>("*",&calc,true);
    rc |= t.checkOperator <31,64>("*",&calc,true);
    rc |= t.checkOperator <33,64>("*",&calc,true);
    rc |= t.checkOperator <64,100>("*",&calc,true);
    rc |= t.checkOperator <128,128>("*",&calc,true);
    rc |= t.checkOperator <10,128>("*",&calc,true);
    rc |= t.checkOperator <31,128>("*",&calc,true);
    rc |= t.checkOperator <33,128>("*",&calc,true);
    rc |= t.checkOperator <100,128>("*",&calc,true);
    rc |= t.checkOperator <10,10>("*",&calc,true);
    rc |= t.checkOperator <10,31>("*",&calc,true);
    rc |= t.checkOperator <10,33>("*",&calc,true);
    rc |= t.checkOperator <10,100>("*",&calc,true);
    rc |= t.checkOperator <31,31>("*",&calc,true);
    rc |= t.checkOperator <31,33>("*",&calc,true);
    rc |= t.checkOperator <31,100>("*",&calc,true);
    rc |= t.checkOperator <33,33>("*",&calc,true);
    rc |= t.checkOperator <33,100>("*",&calc,true);
    rc |= t.checkOperator <100,100>("*",&calc,true);
    rc |= t.checkMutator <1,1>( "*=", &calc,true);
    rc |= t.checkMutator <1,32>( "*=", &calc,true);
    rc |= t.checkMutator <1,64>( "*=", &calc,true);
    rc |= t.checkMutator <1,128>( "*=", &calc,true);
    rc |= t.checkMutator <1,10>( "*=", &calc,true);
    rc |= t.checkMutator <1,31>( "*=", &calc,true);
    rc |= t.checkMutator <1,33>( "*=", &calc,true);
    rc |= t.checkMutator <1,100>( "*=", &calc,true);
    rc |= t.checkMutator <32,32>( "*=", &calc,true);
    rc |= t.checkMutator <32,64>( "*=", &calc,true);
    rc |= t.checkMutator <32,128>( "*=", &calc,true);
    rc |= t.checkMutator <10,32>( "*=", &calc,true);
    rc |= t.checkMutator <31,32>( "*=", &calc,true);
    rc |= t.checkMutator <32,33>( "*=", &calc,true);
    rc |= t.checkMutator <32,100>( "*=", &calc,true);
    rc |= t.checkMutator <64,64>( "*=", &calc,true);
    rc |= t.checkMutator <64,128>( "*=", &calc,true);
    rc |= t.checkMutator <10,64>( "*=", &calc,true);
    rc |= t.checkMutator <31,64>( "*=", &calc,true);
    rc |= t.checkMutator <33,64>( "*=", &calc,true);
    rc |= t.checkMutator <64,100>( "*=", &calc,true);
    rc |= t.checkMutator <128,128>( "*=", &calc,true);
    rc |= t.checkMutator <10,128>( "*=", &calc,true);
    rc |= t.checkMutator <31,128>( "*=", &calc,true);
    rc |= t.checkMutator <33,128>( "*=", &calc,true);
    rc |= t.checkMutator <100,128>( "*=", &calc,true);
    rc |= t.checkMutator <10,10>( "*=", &calc,true);
    rc |= t.checkMutator <10,31>( "*=", &calc,true);
    rc |= t.checkMutator <10,33>( "*=", &calc,true);
    rc |= t.checkMutator <10,100>( "*=", &calc,true);
    rc |= t.checkMutator <31,31>( "*=", &calc,true);
    rc |= t.checkMutator <31,33>( "*=", &calc,true);
    rc |= t.checkMutator <31,100>( "*=", &calc,true);
    rc |= t.checkMutator <33,33>( "*=", &calc,true);
    rc |= t.checkMutator <33,100>( "*=", &calc,true);
    rc |= t.checkMutator <100,100>( "*=", &calc,true);
  ...
  cout<<"Starting <..." << endl;
  rc |= t.checkComparator <1,1>( "<", &calc, SIGNED);
  rc |= t.checkComparator <1,32>( "<", &calc, SIGNED);
  rc |= t.checkComparator <1,64>( "<", &calc, SIGNED);
  rc |= t.checkComparator <1,128>( "<", &calc, SIGNED);
  rc |= t.checkComparator <1,10>( "<", &calc, SIGNED);
  rc |= t.checkComparator <1,31>( "<", &calc, SIGNED);
  rc |= t.checkComparator <1,33>( "<", &calc, SIGNED);
  rc |= t.checkComparator <1,100>( "<", &calc, SIGNED);
  rc |= t.checkComparator <32,32>( "<", &calc, SIGNED);
  rc |= t.checkComparator <32,64>( "<", &calc, SIGNED);
  rc |= t.checkComparator <32,128>( "<", &calc, SIGNED);
  rc |= t.checkComparator <10,32>( "<", &calc, SIGNED);
  rc |= t.checkComparator <31,32>( "<", &calc, SIGNED);
  rc |= t.checkComparator <32,33>( "<", &calc, SIGNED);
  rc |= t.checkComparator <32,100>( "<", &calc, SIGNED);
  rc |= t.checkComparator <64,64>( "<", &calc, SIGNED);
  rc |= t.checkComparator <64,128>( "<", &calc, SIGNED);
  rc |= t.checkComparator <10,64>( "<", &calc, SIGNED);
  rc |= t.checkComparator <31,64>( "<", &calc, SIGNED);
  rc |= t.checkComparator <33,64>( "<", &calc, SIGNED);
  rc |= t.checkComparator <64,100>( "<", &calc, SIGNED);
  rc |= t.checkComparator <128,128>( "<", &calc, SIGNED);
  rc |= t.checkComparator <10,128>( "<", &calc, SIGNED);
  rc |= t.checkComparator <31,128>( "<", &calc, SIGNED);
  rc |= t.checkComparator <33,128>( "<", &calc, SIGNED);
  rc |= t.checkComparator <100,128>( "<", &calc, SIGNED);
  rc |= t.checkComparator <10,10>( "<", &calc, SIGNED);
  rc |= t.checkComparator <10,31>( "<", &calc, SIGNED);
  rc |= t.checkComparator <10,33>( "<", &calc, SIGNED);
  rc |= t.checkComparator <10,100>( "<", &calc, SIGNED);
  rc |= t.checkComparator <31,31>( "<", &calc, SIGNED);
  rc |= t.checkComparator <31,33>( "<", &calc, SIGNED);
  rc |= t.checkComparator <31,100>( "<", &calc, SIGNED);
  rc |= t.checkComparator <33,33>( "<", &calc, SIGNED);
  rc |= t.checkComparator <33,100>( "<", &calc, SIGNED);
  rc |= t.checkComparator <100,100>( "<", &calc, SIGNED);
  ...
  rc |=  t.checkSignedComparator <1,1>( "GT", &calc);
  rc |=  t.checkSignedComparator <1,32>( "GT", &calc);
  rc |=  t.checkSignedComparator <32,1>( "GT", &calc);
  rc |=  t.checkSignedComparator <1,64>( "GT", &calc);
  rc |=  t.checkSignedComparator <64,1>( "GT", &calc);
  rc |=  t.checkSignedComparator <1,128>( "GT", &calc);
  rc |=  t.checkSignedComparator <128,1>( "GT", &calc);
  rc |=  t.checkSignedComparator <1,10>( "GT", &calc);
  rc |=  t.checkSignedComparator <10,1>( "GT", &calc);
  rc |=  t.checkSignedComparator <1,31>( "GT", &calc);
  rc |=  t.checkSignedComparator <31,1>( "GT", &calc);
  rc |=  t.checkSignedComparator <1,33>( "GT", &calc);
  rc |=  t.checkSignedComparator <33,1>( "GT", &calc);
  rc |=  t.checkSignedComparator <1,100>( "GT", &calc);
  rc |=  t.checkSignedComparator <100,1>( "GT", &calc);
  rc |=  t.checkSignedComparator <32,32>( "GT", &calc);
  rc |=  t.checkSignedComparator <32,64>( "GT", &calc);
  rc |=  t.checkSignedComparator <64,32>( "GT", &calc);
  rc |=  t.checkSignedComparator <32,128>( "GT", &calc);
  rc |=  t.checkSignedComparator <128,32>( "GT", &calc);
  rc |=  t.checkSignedComparator <32,10>( "GT", &calc);
  rc |=  t.checkSignedComparator <10,32>( "GT", &calc);
  rc |=  t.checkSignedComparator <32,31>( "GT", &calc);
  rc |=  t.checkSignedComparator <31,32>( "GT", &calc);
  rc |=  t.checkSignedComparator <32,33>( "GT", &calc);
  rc |=  t.checkSignedComparator <33,32>( "GT", &calc);
  rc |=  t.checkSignedComparator <32,100>( "GT", &calc);
  rc |=  t.checkSignedComparator <100,32>( "GT", &calc);
  rc |=  t.checkSignedComparator <64,64>( "GT", &calc);
  rc |=  t.checkSignedComparator <64,128>( "GT", &calc);
  rc |=  t.checkSignedComparator <128,64>( "GT", &calc);
  rc |=  t.checkSignedComparator <64,10>( "GT", &calc);
  rc |=  t.checkSignedComparator <10,64>( "GT", &calc);
  rc |=  t.checkSignedComparator <64,31>( "GT", &calc);
  rc |=  t.checkSignedComparator <31,64>( "GT", &calc);
  rc |=  t.checkSignedComparator <64,33>( "GT", &calc);
  rc |=  t.checkSignedComparator <33,64>( "GT", &calc);
  rc |=  t.checkSignedComparator <64,100>( "GT", &calc);
  rc |=  t.checkSignedComparator <100,64>( "GT", &calc);
  rc |=  t.checkSignedComparator <128,128>( "GT", &calc);
  rc |=  t.checkSignedComparator <128,10>( "GT", &calc);
  rc |=  t.checkSignedComparator <10,128>( "GT", &calc);
  rc |=  t.checkSignedComparator <128,31>( "GT", &calc);
  rc |=  t.checkSignedComparator <31,128>( "GT", &calc);
  rc |=  t.checkSignedComparator <128,33>( "GT", &calc);
  rc |=  t.checkSignedComparator <33,128>( "GT", &calc);
  rc |=  t.checkSignedComparator <128,100>( "GT", &calc);
  rc |=  t.checkSignedComparator <100,128>( "GT", &calc);
  rc |=  t.checkSignedComparator <10,10>( "GT", &calc);
  rc |=  t.checkSignedComparator <10,31>( "GT", &calc);
  rc |=  t.checkSignedComparator <31,10>( "GT", &calc);
  rc |=  t.checkSignedComparator <10,33>( "GT", &calc);
  rc |=  t.checkSignedComparator <33,10>( "GT", &calc);
  rc |=  t.checkSignedComparator <10,100>( "GT", &calc);
  rc |=  t.checkSignedComparator <100,10>( "GT", &calc);
  rc |=  t.checkSignedComparator <31,31>( "GT", &calc);
  rc |=  t.checkSignedComparator <31,33>( "GT", &calc);
  rc |=  t.checkSignedComparator <33,31>( "GT", &calc);
  rc |=  t.checkSignedComparator <31,100>( "GT", &calc);
  rc |=  t.checkSignedComparator <100,31>( "GT", &calc);
  rc |=  t.checkSignedComparator <33,33>( "GT", &calc);
  rc |=  t.checkSignedComparator <33,100>( "GT", &calc);
  rc |=  t.checkSignedComparator <100,33>( "GT", &calc);
  rc |=  t.checkSignedComparator <100,100>( "GT", &calc);

  // signedGE
  cout<<"Starting signedGE..."<<endl;
  rc |=  t.checkSignedComparator <1,1>( "GE", &calc);
  rc |=  t.checkSignedComparator <1,32>( "GE", &calc);
  rc |=  t.checkSignedComparator <32,1>( "GE", &calc);
  rc |=  t.checkSignedComparator <1,64>( "GE", &calc);
  rc |=  t.checkSignedComparator <64,1>( "GE", &calc);
  rc |=  t.checkSignedComparator <1,128>( "GE", &calc);
  rc |=  t.checkSignedComparator <128,1>( "GE", &calc);
  rc |=  t.checkSignedComparator <1,10>( "GE", &calc);
  rc |=  t.checkSignedComparator <10,1>( "GE", &calc);
  rc |=  t.checkSignedComparator <1,31>( "GE", &calc);
  rc |=  t.checkSignedComparator <31,1>( "GE", &calc);
  rc |=  t.checkSignedComparator <1,33>( "GE", &calc);
  rc |=  t.checkSignedComparator <33,1>( "GE", &calc);
  rc |=  t.checkSignedComparator <1,100>( "GE", &calc);
  rc |=  t.checkSignedComparator <100,1>( "GE", &calc);
  rc |=  t.checkSignedComparator <32,32>( "GE", &calc);
  rc |=  t.checkSignedComparator <32,64>( "GE", &calc);
  rc |=  t.checkSignedComparator <64,32>( "GE", &calc);
  rc |=  t.checkSignedComparator <32,128>( "GE", &calc);
  rc |=  t.checkSignedComparator <128,32>( "GE", &calc);
  rc |=  t.checkSignedComparator <32,10>( "GE", &calc);
  rc |=  t.checkSignedComparator <10,32>( "GE", &calc);
  rc |=  t.checkSignedComparator <32,31>( "GE", &calc);
  rc |=  t.checkSignedComparator <31,32>( "GE", &calc);
  rc |=  t.checkSignedComparator <32,33>( "GE", &calc);
  rc |=  t.checkSignedComparator <33,32>( "GE", &calc);
  rc |=  t.checkSignedComparator <32,100>( "GE", &calc);
  rc |=  t.checkSignedComparator <100,32>( "GE", &calc);
  rc |=  t.checkSignedComparator <64,64>( "GE", &calc);
  rc |=  t.checkSignedComparator <64,128>( "GE", &calc);
  rc |=  t.checkSignedComparator <128,64>( "GE", &calc);
  rc |=  t.checkSignedComparator <64,10>( "GE", &calc);
  rc |=  t.checkSignedComparator <10,64>( "GE", &calc);
  rc |=  t.checkSignedComparator <64,31>( "GE", &calc);
  rc |=  t.checkSignedComparator <31,64>( "GE", &calc);
  rc |=  t.checkSignedComparator <64,33>( "GE", &calc);
  rc |=  t.checkSignedComparator <33,64>( "GE", &calc);
  rc |=  t.checkSignedComparator <64,100>( "GE", &calc);
  rc |=  t.checkSignedComparator <100,64>( "GE", &calc);
  rc |=  t.checkSignedComparator <128,128>( "GE", &calc);
  rc |=  t.checkSignedComparator <128,10>( "GE", &calc);
  rc |=  t.checkSignedComparator <10,128>( "GE", &calc);
  rc |=  t.checkSignedComparator <128,31>( "GE", &calc);
  rc |=  t.checkSignedComparator <31,128>( "GE", &calc);
  rc |=  t.checkSignedComparator <128,33>( "GE", &calc);
  rc |=  t.checkSignedComparator <33,128>( "GE", &calc);
  rc |=  t.checkSignedComparator <128,100>( "GE", &calc);
  rc |=  t.checkSignedComparator <100,128>( "GE", &calc);
  rc |=  t.checkSignedComparator <10,10>( "GE", &calc);
  rc |=  t.checkSignedComparator <10,31>( "GE", &calc);
  rc |=  t.checkSignedComparator <31,10>( "GE", &calc);
  rc |=  t.checkSignedComparator <10,33>( "GE", &calc);
  rc |=  t.checkSignedComparator <33,10>( "GE", &calc);
  rc |=  t.checkSignedComparator <10,100>( "GE", &calc);
  rc |=  t.checkSignedComparator <100,10>( "GE", &calc);
  rc |=  t.checkSignedComparator <31,31>( "GE", &calc);
  rc |=  t.checkSignedComparator <31,33>( "GE", &calc);
  rc |=  t.checkSignedComparator <33,31>( "GE", &calc);
  rc |=  t.checkSignedComparator <31,100>( "GE", &calc);
  rc |=  t.checkSignedComparator <100,31>( "GE", &calc);
  rc |=  t.checkSignedComparator <33,33>( "GE", &calc);
  rc |=  t.checkSignedComparator <33,100>( "GE", &calc);
  rc |=  t.checkSignedComparator <100,33>( "GE", &calc);
  rc |=  t.checkSignedComparator <100,100>( "GE", &calc);

  // signedLT
  cout<<"Starting signedLT..."<<endl;
  rc |=  t.checkSignedComparator <1,1>( "LT", &calc);
  rc |=  t.checkSignedComparator <1,32>( "LT", &calc);
  rc |=  t.checkSignedComparator <32,1>( "LT", &calc);
  rc |=  t.checkSignedComparator <1,64>( "LT", &calc);
  rc |=  t.checkSignedComparator <64,1>( "LT", &calc);
  rc |=  t.checkSignedComparator <1,128>( "LT", &calc);
  rc |=  t.checkSignedComparator <128,1>( "LT", &calc);
  rc |=  t.checkSignedComparator <1,10>( "LT", &calc);
  rc |=  t.checkSignedComparator <10,1>( "LT", &calc);
  rc |=  t.checkSignedComparator <1,31>( "LT", &calc);
  rc |=  t.checkSignedComparator <31,1>( "LT", &calc);
  rc |=  t.checkSignedComparator <1,33>( "LT", &calc);
  rc |=  t.checkSignedComparator <33,1>( "LT", &calc);
  rc |=  t.checkSignedComparator <1,100>( "LT", &calc);
  rc |=  t.checkSignedComparator <100,1>( "LT", &calc);
  rc |=  t.checkSignedComparator <32,32>( "LT", &calc);
  rc |=  t.checkSignedComparator <32,64>( "LT", &calc);
  rc |=  t.checkSignedComparator <64,32>( "LT", &calc);
  rc |=  t.checkSignedComparator <32,128>( "LT", &calc);
  rc |=  t.checkSignedComparator <128,32>( "LT", &calc);
  rc |=  t.checkSignedComparator <32,10>( "LT", &calc);
  rc |=  t.checkSignedComparator <10,32>( "LT", &calc);
  rc |=  t.checkSignedComparator <32,31>( "LT", &calc);
  rc |=  t.checkSignedComparator <31,32>( "LT", &calc);
  rc |=  t.checkSignedComparator <32,33>( "LT", &calc);
  rc |=  t.checkSignedComparator <33,32>( "LT", &calc);
  rc |=  t.checkSignedComparator <32,100>( "LT", &calc);
  rc |=  t.checkSignedComparator <100,32>( "LT", &calc);
  rc |=  t.checkSignedComparator <64,64>( "LT", &calc);
  rc |=  t.checkSignedComparator <64,128>( "LT", &calc);
  rc |=  t.checkSignedComparator <128,64>( "LT", &calc);
  rc |=  t.checkSignedComparator <64,10>( "LT", &calc);
  rc |=  t.checkSignedComparator <10,64>( "LT", &calc);
  rc |=  t.checkSignedComparator <64,31>( "LT", &calc);
  rc |=  t.checkSignedComparator <31,64>( "LT", &calc);
  rc |=  t.checkSignedComparator <64,33>( "LT", &calc);
  rc |=  t.checkSignedComparator <33,64>( "LT", &calc);
  rc |=  t.checkSignedComparator <64,100>( "LT", &calc);
  rc |=  t.checkSignedComparator <100,64>( "LT", &calc);
  rc |=  t.checkSignedComparator <128,128>( "LT", &calc);
  rc |=  t.checkSignedComparator <128,10>( "LT", &calc);
  rc |=  t.checkSignedComparator <10,128>( "LT", &calc);
  rc |=  t.checkSignedComparator <128,31>( "LT", &calc);
  rc |=  t.checkSignedComparator <31,128>( "LT", &calc);
  rc |=  t.checkSignedComparator <128,33>( "LT", &calc);
  rc |=  t.checkSignedComparator <33,128>( "LT", &calc);
  rc |=  t.checkSignedComparator <128,100>( "LT", &calc);
  rc |=  t.checkSignedComparator <100,128>( "LT", &calc);
  rc |=  t.checkSignedComparator <10,10>( "LT", &calc);
  rc |=  t.checkSignedComparator <10,31>( "LT", &calc);
  rc |=  t.checkSignedComparator <31,10>( "LT", &calc);
  rc |=  t.checkSignedComparator <10,33>( "LT", &calc);
  rc |=  t.checkSignedComparator <33,10>( "LT", &calc);
  rc |=  t.checkSignedComparator <10,100>( "LT", &calc);
  rc |=  t.checkSignedComparator <100,10>( "LT", &calc);
  rc |=  t.checkSignedComparator <31,31>( "LT", &calc);
  rc |=  t.checkSignedComparator <31,33>( "LT", &calc);
  rc |=  t.checkSignedComparator <33,31>( "LT", &calc);
  rc |=  t.checkSignedComparator <31,100>( "LT", &calc);
  rc |=  t.checkSignedComparator <100,31>( "LT", &calc);
  rc |=  t.checkSignedComparator <33,33>( "LT", &calc);
  rc |=  t.checkSignedComparator <33,100>( "LT", &calc);
  rc |=  t.checkSignedComparator <100,33>( "LT", &calc);
  rc |=  t.checkSignedComparator <100,100>( "LT", &calc);

  // signedLE
  cout<<"Starting signedLE..."<<endl;
  rc |=  t.checkSignedComparator <1,1>("LE", &calc);
  rc |=  t.checkSignedComparator <1,32>("LE", &calc);
  rc |=  t.checkSignedComparator <32,1>("LE", &calc);
  rc |=  t.checkSignedComparator <1,64>("LE", &calc);
  rc |=  t.checkSignedComparator <64,1>("LE", &calc);
  rc |=  t.checkSignedComparator <1,128>("LE", &calc);
  rc |=  t.checkSignedComparator <128,1>("LE", &calc);
  rc |=  t.checkSignedComparator <1,10>("LE", &calc);
  rc |=  t.checkSignedComparator <10,1>("LE", &calc);
  rc |=  t.checkSignedComparator <1,31>("LE", &calc);
  rc |=  t.checkSignedComparator <31,1>("LE", &calc);
  rc |=  t.checkSignedComparator <1,33>("LE", &calc);
  rc |=  t.checkSignedComparator <33,1>("LE", &calc);
  rc |=  t.checkSignedComparator <1,100>("LE", &calc);
  rc |=  t.checkSignedComparator <100,1>("LE", &calc);
  rc |=  t.checkSignedComparator <32,32>("LE", &calc);
  rc |=  t.checkSignedComparator <32,64>("LE", &calc);
  rc |=  t.checkSignedComparator <64,32>("LE", &calc);
  rc |=  t.checkSignedComparator <32,128>("LE", &calc);
  rc |=  t.checkSignedComparator <128,32>("LE", &calc);
  rc |=  t.checkSignedComparator <32,10>("LE", &calc);
  rc |=  t.checkSignedComparator <10,32>("LE", &calc);
  rc |=  t.checkSignedComparator <32,31>("LE", &calc);
  rc |=  t.checkSignedComparator <31,32>("LE", &calc);
  rc |=  t.checkSignedComparator <32,33>("LE", &calc);
  rc |=  t.checkSignedComparator <33,32>("LE", &calc);
  rc |=  t.checkSignedComparator <32,100>("LE", &calc);
  rc |=  t.checkSignedComparator <100,32>("LE", &calc);
  rc |=  t.checkSignedComparator <64,64>("LE", &calc);
  rc |=  t.checkSignedComparator <64,128>("LE", &calc);
  rc |=  t.checkSignedComparator <128,64>("LE", &calc);
  rc |=  t.checkSignedComparator <64,10>("LE", &calc);
  rc |=  t.checkSignedComparator <10,64>("LE", &calc);
  rc |=  t.checkSignedComparator <64,31>("LE", &calc);
  rc |=  t.checkSignedComparator <31,64>("LE", &calc);
  rc |=  t.checkSignedComparator <64,33>("LE", &calc);
  rc |=  t.checkSignedComparator <33,64>("LE", &calc);
  rc |=  t.checkSignedComparator <64,100>("LE", &calc);
  rc |=  t.checkSignedComparator <100,64>("LE", &calc);
  rc |=  t.checkSignedComparator <128,128>("LE", &calc);
  rc |=  t.checkSignedComparator <128,10>("LE", &calc);
  rc |=  t.checkSignedComparator <10,128>("LE", &calc);
  rc |=  t.checkSignedComparator <128,31>("LE", &calc);
  rc |=  t.checkSignedComparator <31,128>("LE", &calc);
  rc |=  t.checkSignedComparator <128,33>("LE", &calc);
  rc |=  t.checkSignedComparator <33,128>("LE", &calc);
  rc |=  t.checkSignedComparator <128,100>("LE", &calc);
  rc |=  t.checkSignedComparator <100,128>("LE", &calc);
  rc |=  t.checkSignedComparator <10,10>("LE", &calc);
  rc |=  t.checkSignedComparator <10,31>("LE", &calc);
  rc |=  t.checkSignedComparator <31,10>("LE", &calc);
  rc |=  t.checkSignedComparator <10,33>("LE", &calc);
  rc |=  t.checkSignedComparator <33,10>("LE", &calc);
  rc |=  t.checkSignedComparator <10,100>("LE", &calc);
  rc |=  t.checkSignedComparator <100,10>("LE", &calc);
  rc |=  t.checkSignedComparator <31,31>("LE", &calc);
  rc |=  t.checkSignedComparator <31,33>("LE", &calc);
  rc |=  t.checkSignedComparator <33,31>("LE", &calc);
  rc |=  t.checkSignedComparator <31,100>("LE", &calc);
  rc |=  t.checkSignedComparator <100,31>("LE", &calc);
  rc |=  t.checkSignedComparator <33,33>("LE", &calc);
  rc |=  t.checkSignedComparator <33,100>("LE", &calc);
  rc |=  t.checkSignedComparator <100,33>("LE", &calc);
  rc |=  t.checkSignedComparator <100,100>("LE", &calc);
  ...
  rc |= t.checkBitAccessors <1>();
  rc |= t.checkBitAccessors <32>();
  rc |= t.checkBitAccessors <64>();
  rc |= t.checkBitAccessors <128>();
  rc |= t.checkBitAccessors <10>();
  rc |= t.checkBitAccessors <31>();
  rc |= t.checkBitAccessors <33>();
  rc |= t.checkBitAccessors <100>();


  // get field
  // set field
  cout<<"Starting field accessors..."<<endl;
  rc |= t.checkFieldAccessors <1,1>();
  rc |= t.checkFieldAccessors <1,32>();
  rc |= t.checkFieldAccessors <1,64>();
  rc |= t.checkFieldAccessors <1,128>();
  rc |= t.checkFieldAccessors <1,10>();
  rc |= t.checkFieldAccessors <1,31>();
  rc |= t.checkFieldAccessors <1,33>();
  rc |= t.checkFieldAccessors <1,100>();
  rc |= t.checkFieldAccessors <32,32>();
  rc |= t.checkFieldAccessors <32,64>();
  rc |= t.checkFieldAccessors <32,128>();
  rc |= t.checkFieldAccessors <10,32>();
  rc |= t.checkFieldAccessors <31,32>();
  rc |= t.checkFieldAccessors <32,33>();
  rc |= t.checkFieldAccessors <32,100>();
  rc |= t.checkFieldAccessors <64,64>();
  rc |= t.checkFieldAccessors <64,128>();
  rc |= t.checkFieldAccessors <10,64>();
  rc |= t.checkFieldAccessors <31,64>();
  rc |= t.checkFieldAccessors <33,64>();
  rc |= t.checkFieldAccessors <64,100>();
  rc |= t.checkFieldAccessors <128,128>();
  rc |= t.checkFieldAccessors <10,128>();
  rc |= t.checkFieldAccessors <31,128>();
  rc |= t.checkFieldAccessors <33,128>();
  rc |= t.checkFieldAccessors <100,128>();
  rc |= t.checkFieldAccessors <10,10>();
  rc |= t.checkFieldAccessors <10,31>();
  rc |= t.checkFieldAccessors <10,33>();
  rc |= t.checkFieldAccessors <10,100>();
  rc |= t.checkFieldAccessors <31,31>();
  rc |= t.checkFieldAccessors <31,33>();
  rc |= t.checkFieldAccessors <31,100>();
  rc |= t.checkFieldAccessors <33,33>();
  rc |= t.checkFieldAccessors <33,100>();
  rc |= t.checkFieldAccessors <100,100>();

  // sign extend
  cout<<"Starting sign extensions..."<<endl;
  rc |= t.checkSignExtends <1,1>();
  rc |= t.checkSignExtends <1,32>();
  rc |= t.checkSignExtends <32,1>();
  rc |= t.checkSignExtends <1,64>();
  rc |= t.checkSignExtends <64,1>();
  rc |= t.checkSignExtends <1,128>();
  rc |= t.checkSignExtends <128,1>();
  rc |= t.checkSignExtends <1,10>();
  rc |= t.checkSignExtends <10,1>();
  rc |= t.checkSignExtends <1,31>();
  rc |= t.checkSignExtends <31,1>();
  rc |= t.checkSignExtends <1,33>();
  rc |= t.checkSignExtends <33,1>();
  rc |= t.checkSignExtends <1,100>();
  rc |= t.checkSignExtends <100,1>();
  rc |= t.checkSignExtends <32,32>();
  rc |= t.checkSignExtends <32,64>();
  rc |= t.checkSignExtends <64,32>();
  rc |= t.checkSignExtends <32,128>();
  rc |= t.checkSignExtends <128,32>();
  rc |= t.checkSignExtends <32,10>();
  rc |= t.checkSignExtends <10,32>();
  rc |= t.checkSignExtends <32,31>();
  rc |= t.checkSignExtends <31,32>();
  rc |= t.checkSignExtends <32,33>();
  rc |= t.checkSignExtends <33,32>();
  rc |= t.checkSignExtends <32,100>();
  rc |= t.checkSignExtends <100,32>();
  rc |= t.checkSignExtends <64,64>();
  rc |= t.checkSignExtends <64,128>();
  rc |= t.checkSignExtends <128,64>();
  rc |= t.checkSignExtends <64,10>();
  rc |= t.checkSignExtends <10,64>();
  rc |= t.checkSignExtends <64,31>();
  rc |= t.checkSignExtends <31,64>();
  rc |= t.checkSignExtends <64,33>();
  rc |= t.checkSignExtends <33,64>();
  rc |= t.checkSignExtends <64,100>();
  rc |= t.checkSignExtends <100,64>();
  rc |= t.checkSignExtends <128,128>();
  rc |= t.checkSignExtends <128,10>();
  rc |= t.checkSignExtends <10,128>();
  rc |= t.checkSignExtends <128,31>();
  rc |= t.checkSignExtends <31,128>();
  rc |= t.checkSignExtends <128,33>();
  rc |= t.checkSignExtends <33,128>();
  rc |= t.checkSignExtends <128,100>();
  rc |= t.checkSignExtends <100,128>();
  rc |= t.checkSignExtends <10,10>();
  rc |= t.checkSignExtends <10,31>();
  rc |= t.checkSignExtends <31,10>();
  rc |= t.checkSignExtends <10,33>();
  rc |= t.checkSignExtends <33,10>();
  rc |= t.checkSignExtends <10,100>();
  rc |= t.checkSignExtends <100,10>();
  rc |= t.checkSignExtends <31,31>();
  rc |= t.checkSignExtends <31,33>();
  rc |= t.checkSignExtends <33,31>();
  rc |= t.checkSignExtends <31,100>();
  rc |= t.checkSignExtends <100,31>();
  rc |= t.checkSignExtends <33,33>();
  rc |= t.checkSignExtends <33,100>();
  rc |= t.checkSignExtends <100,33>();
  rc |= t.checkSignExtends <100,100>();
                                                                                                                                      
  // invert
  // negate
  // not
  cout<<"Starting inversions..."<<endl;
  rc |= t.checkInversions <1>();
  rc |= t.checkInversions <32>();
  rc |= t.checkInversions <64>();
  rc |= t.checkInversions <128>();
  rc |= t.checkInversions <10>();
  rc |= t.checkInversions <31>();
  rc |= t.checkInversions <33>();
  rc |= t.checkInversions <100>();
  ...
  rc |= t.checkShifts <32>();
  rc |= t.checkShifts <64>();
  rc |= t.checkShifts <128>();
  rc |= t.checkShifts <10>();
  rc |= t.checkShifts <31>();
  rc |= t.checkShifts <33>();
  rc |= t.checkShifts <100>();

  // setAll
  cout<<"Starting setAlls..."<<endl;
  rc |= t.checkSetAlls <1>();
  rc |= t.checkSetAlls <32>();
  rc |= t.checkSetAlls <64>();
  rc |= t.checkSetAlls <128>();
  rc |= t.checkSetAlls <10>();
  rc |= t.checkSetAlls <31>();
  rc |= t.checkSetAlls <33>();
  rc |= t.checkSetAlls <100>();
                                                                                                                                      
                                                                                                                                      
  // clearAll
  cout<<"Starting clearAlls..."<<endl;
  rc |= t.checkClearAlls <1>();
  rc |= t.checkClearAlls <32>();
  rc |= t.checkClearAlls <64>();
  rc |= t.checkClearAlls <128>();
  rc |= t.checkClearAlls <10>();
  rc |= t.checkClearAlls <31>();
  rc |= t.checkClearAlls <33>();
  rc |= t.checkClearAlls <100>();
                                                                                                                                      
                                                                                                                                      
  // getInt
  cout<<"Starting getInts..."<<endl;
  rc |= t.checkGetInts <1>();
  rc |= t.checkGetInts <32>();
  rc |= t.checkGetInts <64>();
  rc |= t.checkGetInts <128>();
  rc |= t.checkGetInts <10>();
  rc |= t.checkGetInts <31>();
  rc |= t.checkGetInts <33>();
  rc |= t.checkGetInts <100>();
                                                                                                                                      
  // and
  // or
  // xor
  cout<<"Starting logicals..."<<endl;
  rc |= t.checkLogicals <1,1>();
  rc |= t.checkLogicals <1,32>();
  rc |= t.checkLogicals <1,64>();
  rc |= t.checkLogicals <1,128>();
  rc |= t.checkLogicals <1,10>();
  rc |= t.checkLogicals <1,31>();
  rc |= t.checkLogicals <1,33>();
  rc |= t.checkLogicals <1,100>();
  rc |= t.checkLogicals <32,32>();
  rc |= t.checkLogicals <32,64>();
  rc |= t.checkLogicals <32,128>();
  rc |= t.checkLogicals <10,32>();
  rc |= t.checkLogicals <31,32>();
  rc |= t.checkLogicals <32,33>();
  rc |= t.checkLogicals <32,100>();
  rc |= t.checkLogicals <64,64>();
  rc |= t.checkLogicals <64,128>();
  rc |= t.checkLogicals <10,64>();
  rc |= t.checkLogicals <31,64>();
  rc |= t.checkLogicals <33,64>();
  rc |= t.checkLogicals <64,100>();
  rc |= t.checkLogicals <128,128>();
  rc |= t.checkLogicals <10,128>();
  rc |= t.checkLogicals <31,128>();
  rc |= t.checkLogicals <33,128>();
  rc |= t.checkLogicals <100,128>();
  rc |= t.checkLogicals <10,10>();
  rc |= t.checkLogicals <10,31>();
  rc |= t.checkLogicals <10,33>();
  rc |= t.checkLogicals <10,100>();
  rc |= t.checkLogicals <31,31>();
  rc |= t.checkLogicals <31,33>();
  rc |= t.checkLogicals <31,100>();
  rc |= t.checkLogicals <33,33>();
  rc |= t.checkLogicals <33,100>();
  rc |= t.checkLogicals <100,100>();
  ...
  rc |= t.checkMisc <1,32>(); 
  rc |= t.checkMisc <1,64>(); 
  rc |= t.checkMisc <1,128>(); 
  rc |= t.checkMisc <1,10>(); 
  rc |= t.checkMisc <1,31>(); 
  rc |= t.checkMisc <1,33>(); 
  rc |= t.checkMisc <1,100>(); 
  rc |= t.checkMisc <32,32>(); 
  rc |= t.checkMisc <32,64>(); 
  rc |= t.checkMisc <32,128>(); 
  rc |= t.checkMisc <10,32>(); 
  rc |= t.checkMisc <31,32>(); 
  rc |= t.checkMisc <32,33>(); 
  rc |= t.checkMisc <32,100>(); 
  rc |= t.checkMisc <64,64>(); 
  rc |= t.checkMisc <64,128>(); 
  rc |= t.checkMisc <10,64>(); 
  rc |= t.checkMisc <31,64>(); 
  rc |= t.checkMisc <33,64>(); 
  rc |= t.checkMisc <64,100>(); 
  rc |= t.checkMisc <128,128>(); 
  rc |= t.checkMisc <10,128>(); 
  rc |= t.checkMisc <31,128>(); 
  rc |= t.checkMisc <33,128>(); 
  rc |= t.checkMisc <100,128>(); 
  rc |= t.checkMisc <10,10>(); 
  rc |= t.checkMisc <10,31>(); 
  rc |= t.checkMisc <10,33>(); 
  rc |= t.checkMisc <10,100>(); 
  rc |= t.checkMisc <31,31>(); 
  rc |= t.checkMisc <31,33>(); 
  rc |= t.checkMisc <31,100>(); 
  rc |= t.checkMisc <33,33>(); 
  rc |= t.checkMisc <33,100>(); 
  rc |= t.checkMisc <100,100>(); 
