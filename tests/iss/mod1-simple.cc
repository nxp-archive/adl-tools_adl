...
namespace adliss {
  ...
  struct P : public IssCore, public InstrCountBase {
    ...
    struct HID0_t : public NoTag<bits<32> > {
      HID0_t()
      {};
    };
    ...
    struct HID1_t : public NoTag<bits<32> > {
      HID1_t()
      {};
    };
    ...
    struct LR_t : public NoTag<bits<32> > {
      LR_t()
      {};
    };
    ...
    void XER_write_internal(const bits<32> &x) {
      XER().set_data() = (x & ~XER()._reserved_mask);
    };
    ...
    // InstrArgsLogger for "add"
    static int  _sym34(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
    ...
    // InstrArgsLogger for "addi"
    static int  _sym40(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "addic"
    static int  _sym46(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "addic."
    static int  _sym52(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "addis"
    static int  _sym58(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "addme"
    static int  _sym64(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "addme."
    static int  _sym70(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "addmeo"
    static int  _sym76(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "addo"
    static int  _sym82(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "andi."
    static int  _sym88(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "b"
    static int  _sym94(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "bc"
    static int  _sym100(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "bcl"
    static int  _sym106(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "bclr"
    static int  _sym112(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "bclrl"
    static int  _sym118(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "bl"
    static int  _sym232(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "cmp"
    static int  _sym340(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "cmpi"
    static int  _sym346(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "halt"
    static int  _sym364(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "lbz"
    static int  _sym376(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "lbzu"
    static int  _sym382(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "lhz"
    static int  _sym388(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "lmw"
    static int  _sym406(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "lwz"
    static int  _sym412(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "lwzu"
    static int  _sym418(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "lwzx"
    static int  _sym424(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "mfspr"
    static int  _sym436(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "mtspr"
    static int  _sym460(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "mulli"
    static int  _sym466(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "mullw"
    static int  _sym472(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "or"
    static int  _sym478(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "ori"
    static int  _sym484(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "oris"
    static int  _sym490(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "rlwinm"
    static int  _sym496(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "sc"
    static int  _sym508(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "srw"
    static int  _sym520(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "stb"
    static int  _sym526(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "sth"
    static int  _sym532(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "sthx"
    static int  _sym538(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "stmw"
    static int  _sym544(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "stw"
    static int  _sym550(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "stwu"
    static int  _sym556(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
    ...
    // InstrArgsLogger for "stwx"
    static int  _sym562(std::ostream &os, addr_t direction,const uint32_t* insn)
    {
      // direction     0:  sources 
      // direction     1:  targets 
      // direction   >=2:  sources and targets
      ...
      switch (__sym27[0] & 0xfc000000) {
        case 0x0: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"halt",_sym364);
            }
          }
        ...
        case 0x1c000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"mulli",_sym466);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x2c000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"cmpi",_sym346);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x30000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"addic",_sym46);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x34000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"addic.",_sym52);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x38000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"addi",_sym40);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x3c000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"addis",_sym58);
            }
          }
          NIA_write_simple(CIA_read() + 4);
          ...
          switch (__sym27[0] & 0x3) {
            case 0x0: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"bc",_sym100);
                }
              }
              NIA_write_simple(CIA_read() + 4);
            ...
            case 0x1: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"bcl",_sym106);
                }
              }
              NIA_write_simple(CIA_read() + 4);
          ...
          switch (__sym27[0] & 0x7fe) {
            case 0x2: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"sc",_sym508);
                }
              }
              NIA_write_simple(CIA_read() + 4);
              instr_handler_sc();
          ...
          switch (__sym27[0] & 0x3) {
            case 0x0: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"b",_sym94);
                }
              }
              NIA_write_simple(CIA_read() + 4);
            ...
            case 0x1: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"bl",_sym232);
                }
              }
              NIA_write_simple(CIA_read() + 4);
          ...
          switch (__sym27[0] & 0x7ff) {
            case 0x20: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"bclr",_sym112);
                }
              }
              NIA_write_simple(CIA_read() + 4);
            ...
            case 0x21: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"bclrl",_sym118);
                }
              }
              NIA_write_simple(CIA_read() + 4);
        ...
        case 0x54000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"rlwinm",_sym496);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x60000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"ori",_sym484);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x64000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"oris",_sym490);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x70000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"andi.",_sym88);
            }
          }
          NIA_write_simple(CIA_read() + 4);
          ...
          switch (__sym27[0] & 0x7fe) {
            case 0x0: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"cmp",_sym340);
                }
              }
              NIA_write_simple(CIA_read() + 4);
            ...
            case 0x2e: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"lwzx",_sym424);
                }
              }
              NIA_write_simple(CIA_read() + 4);
            ...
            case 0x12e: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"stwx",_sym562);
                }
              }
              NIA_write_simple(CIA_read() + 4);
              ...
              switch (__sym27[0] & 0x1) {
                case 0x1: {
                  ...
                  if (Tracing) {
                    ...
                    if (_trace_mode & ttInstrArgs) {
                      _logger->log_instr_args(__sym27,8,"addme.",_sym70);
                    }
                  }
                  NIA_write_simple(CIA_read() + 4);
                ...
                default:
                 {// Instruction:  "addme"
                  if (Tracing) {
                    ...
                    if (_trace_mode & ttInstrArgs) {
                      _logger->log_instr_args(__sym27,8,"addme",_sym64);
                    }
                  }
                  NIA_write_simple(CIA_read() + 4);
            ...
            case 0x1d6: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"mullw",_sym472);
                }
              }
              NIA_write_simple(CIA_read() + 4);
            ...
            case 0x214: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"add",_sym34);
                }
              }
              NIA_write_simple(CIA_read() + 4);
            ...
            case 0x2a6: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"mfspr",_sym436);
                }
              }
              NIA_write_simple(CIA_read() + 4);
            ...
            case 0x32e: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"sthx",_sym538);
                }
              }
              NIA_write_simple(CIA_read() + 4);
            ...
            case 0x378: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"or",_sym478);
                }
              }
              NIA_write_simple(CIA_read() + 4);
            ...
            case 0x3a6: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"mtspr",_sym460);
                }
              }
              NIA_write_simple(CIA_read() + 4);
            ...
            case 0x430: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"srw",_sym520);
                }
              }
              NIA_write_simple(CIA_read() + 4);
            ...
            case 0x5d4: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"addmeo",_sym76);
                }
              }
              NIA_write_simple(CIA_read() + 4);
            ...
            case 0x614: {
              ...
              if (Tracing) {
                ...
                if (_trace_mode & ttInstrArgs) {
                  _logger->log_instr_args(__sym27,8,"addo",_sym82);
                }
              }
              NIA_write_simple(CIA_read() + 4);
        ...
        case 0x80000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"lwz",_sym412);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x84000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"lwzu",_sym418);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x88000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"lbz",_sym376);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x8c000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"lbzu",_sym382);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x90000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"stw",_sym550);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x94000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"stwu",_sym556);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0x98000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"stb",_sym526);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0xa0000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"lhz",_sym388);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0xb0000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"sth",_sym532);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0xb8000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"lmw",_sym406);
            }
          }
          NIA_write_simple(CIA_read() + 4);
        ...
        case 0xbc000000: {
          ...
          if (Tracing) {
            ...
            if (_trace_mode & ttInstrArgs) {
              _logger->log_instr_args(__sym27,8,"stmw",_sym544);
            }
          }
          NIA_write_simple(CIA_read() + 4);
    ...
    virtual unsigned disassemble(std::ostream &o,addr_t addr,bool trans,int tindex) const
    {
      uint32_t instr[2];
      instr[0] = debug_instr_read_internal(addr + 0,trans,32);
      return disassembleInternal(o,addr,instr,trans,-1);
    }
    ...
    #else
    {
      switch (instr[0] & 0xfc000000) {
        case 0x0: {
          // Instruction:  "halt"
          instr_disasm_halt(o,addr,instr);
          return 4;
        }
        break;
        case 0x1c000000: {
          // Instruction:  "mulli"
          instr_disasm_mulli(o,addr,instr);
          return 4;
        }
        break;
        case 0x2c000000: {
          // Instruction:  "cmpi"
          instr_disasm_cmpi(o,addr,instr);
          return 4;
        }
        break;
        case 0x30000000: {
          // Instruction:  "addic"
          instr_disasm_addic(o,addr,instr);
          return 4;
        }
        break;
        case 0x34000000: {
          // Instruction:  "addic."
          instr_disasm_addic_(o,addr,instr);
          return 4;
        }
        break;
        case 0x38000000: {
          // Instruction:  "addi"
          instr_disasm_addi(o,addr,instr);
          return 4;
        }
        break;
        case 0x3c000000: {
          // Instruction:  "addis"
          instr_disasm_addis(o,addr,instr);
          return 4;
        }
        break;
        case 0x40000000: {
          switch (instr[0] & 0x3) {
            case 0x0: {
              // Instruction:  "bc"
              instr_disasm_bc(o,addr,instr);
              return 4;
            }
            break;
            case 0x1: {
              // Instruction:  "bcl"
              instr_disasm_bcl(o,addr,instr);
              return 4;
            }
            break;
            default:
            disasm_illop(o,addr,instr);
            return 4;
            break;
          }
        }
        break;
        case 0x44000000: {
          switch (instr[0] & 0x7fe) {
            case 0x2: {
              // Instruction:  "sc"
              instr_disasm_sc(o,addr,instr);
              return 4;
            }
            break;
            default:
        ...
        case 0x48000000: {
          switch (instr[0] & 0x3) {
            case 0x0: {
              // Instruction:  "b"
              instr_disasm_b(o,addr,instr);
              return 4;
            }
            break;
            case 0x1: {
              // Instruction:  "bl"
              instr_disasm_bl(o,addr,instr);
              return 4;
            }
            break;
            default:
        ...
        break;
        case 0x4c000000: {
          switch (instr[0] & 0x7ff) {
            case 0x20: {
              // Instruction:  "bclr"
              instr_disasm_bclr(o,addr,instr);
              return 4;
            }
            break;
            case 0x21: {
              // Instruction:  "bclrl"
              instr_disasm_bclrl(o,addr,instr);
              return 4;
            }
            break;
            default:
        ...
        case 0x54000000: {
          // Instruction:  "rlwinm"
          instr_disasm_rlwinm(o,addr,instr);
          return 4;
        }
        break;
        case 0x60000000: {
          // Instruction:  "ori"
          instr_disasm_ori(o,addr,instr);
          return 4;
        }
        break;
        case 0x64000000: {
          // Instruction:  "oris"
          instr_disasm_oris(o,addr,instr);
          return 4;
        }
        break;
        case 0x70000000: {
          // Instruction:  "andi."
          instr_disasm_andi_(o,addr,instr);
          return 4;
        }
        break;
        case 0x7c000000: {
          switch (instr[0] & 0x7fe) {
            case 0x0: {
              // Instruction:  "cmp"
              instr_disasm_cmp(o,addr,instr);
              return 4;
            }
            break;
            case 0x2e: {
              // Instruction:  "lwzx"
              instr_disasm_lwzx(o,addr,instr);
              return 4;
            }
            break;
            case 0x12e: {
              // Instruction:  "stwx"
              instr_disasm_stwx(o,addr,instr);
              return 4;
            }
            break;
            case 0x1d4: {
              switch (instr[0] & 0x1) {
                case 0x1: {
                  // Instruction:  "addme."
                  instr_disasm_addme_(o,addr,instr);
                  return 4;
                }
                break;
                default:
                 {// Instruction:  "addme"
                  instr_disasm_addme(o,addr,instr);
                  return 4;
                }
                break;
              }
            ...
            case 0x1d6: {
              // Instruction:  "mullw"
              instr_disasm_mullw(o,addr,instr);
              return 4;
            }
            break;
            case 0x214: {
              // Instruction:  "add"
              instr_disasm_add(o,addr,instr);
              return 4;
            }
            break;
            case 0x2a6: {
              // Instruction:  "mfspr"
              instr_disasm_mfspr(o,addr,instr);
              return 4;
            }
            break;
            case 0x32e: {
              // Instruction:  "sthx"
              instr_disasm_sthx(o,addr,instr);
              return 4;
            }
            break;
            case 0x378: {
              // Instruction:  "or"
              instr_disasm_or(o,addr,instr);
              return 4;
            }
            break;
            case 0x3a6: {
              // Instruction:  "mtspr"
              instr_disasm_mtspr(o,addr,instr);
              return 4;
            }
            break;
            case 0x430: {
              // Instruction:  "srw"
              instr_disasm_srw(o,addr,instr);
              return 4;
            }
            break;
            case 0x5d4: {
              // Instruction:  "addmeo"
              instr_disasm_addmeo(o,addr,instr);
              return 4;
            }
            break;
            case 0x614: {
              // Instruction:  "addo"
              instr_disasm_addo(o,addr,instr);
              return 4;
            }
            break;
            default:
        ...
        case 0x80000000: {
          // Instruction:  "lwz"
          instr_disasm_lwz(o,addr,instr);
          return 4;
        }
        break;
        case 0x84000000: {
          // Instruction:  "lwzu"
          instr_disasm_lwzu(o,addr,instr);
          return 4;
        }
        break;
        case 0x88000000: {
          // Instruction:  "lbz"
          instr_disasm_lbz(o,addr,instr);
          return 4;
        }
        break;
        case 0x8c000000: {
          // Instruction:  "lbzu"
          instr_disasm_lbzu(o,addr,instr);
          return 4;
        }
        break;
        case 0x90000000: {
          // Instruction:  "stw"
          instr_disasm_stw(o,addr,instr);
          return 4;
        }
        break;
        case 0x94000000: {
          // Instruction:  "stwu"
          instr_disasm_stwu(o,addr,instr);
          return 4;
        }
        break;
        case 0x98000000: {
          // Instruction:  "stb"
          instr_disasm_stb(o,addr,instr);
          return 4;
        }
        break;
        case 0xa0000000: {
          // Instruction:  "lhz"
          instr_disasm_lhz(o,addr,instr);
          return 4;
        }
        break;
        case 0xb0000000: {
          // Instruction:  "sth"
          instr_disasm_sth(o,addr,instr);
          return 4;
        }
        break;
        case 0xb8000000: {
          // Instruction:  "lmw"
          instr_disasm_lmw(o,addr,instr);
          return 4;
        }
        break;
        case 0xbc000000: {
          // Instruction:  "stmw"
          instr_disasm_stmw(o,addr,instr);
          return 4;
        }
        break;
        default:
  ...
  #ifndef ADL_HEADER
  const char* getModelFileName() {
    static const char* fname = "mod1-simple";
    return fname;
  }
