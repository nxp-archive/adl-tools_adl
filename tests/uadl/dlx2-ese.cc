...
namespace uadl {
  ...
  Inst_P *OSM_P::get_instr_add(void *x)
  {
    ...
    Inst_sfx<add_sfx_Src1, add_sfx_Src2, DummyOp, add_sfx_Trg, DummyOp> *ic = new Inst_sfx<add_sfx_Src1, add_sfx_Src2, DummyOp, add_sfx_Trg, DummyOp>;
    _instr_alloc_count++;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<addi_sfx_Src1, DummyOp, DummyOp, addi_sfx_Trg, DummyOp> *ic = new Inst_sfx<addi_sfx_Src1, DummyOp, DummyOp, addi_sfx_Trg, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<addic_sfx_Src1, DummyOp, DummyOp, addic_sfx_Trg, addic_sfx_TrgFlags> *ic = new Inst_sfx<addic_sfx_Src1, DummyOp, DummyOp, addic_sfx_Trg, addic_sfx_TrgFlags>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<addic__sfx_Src1, DummyOp, addic__sfx_SrcFlags, addic__sfx_Trg, addic__sfx_TrgFlags> *ic = new Inst_sfx<addic__sfx_Src1, DummyOp, addic__sfx_SrcFlags, addic__sfx_Trg, addic__sfx_TrgFlags>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<addis_sfx_Src1, DummyOp, DummyOp, addis_sfx_Trg, DummyOp> *ic = new Inst_sfx<addis_sfx_Src1, DummyOp, DummyOp, addis_sfx_Trg, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<andi__sfx_Src1, DummyOp, andi__sfx_SrcFlags, andi__sfx_Trg, andi__sfx_TrgFlags> *ic = new Inst_sfx<andi__sfx_Src1, DummyOp, andi__sfx_SrcFlags, andi__sfx_Trg, andi__sfx_TrgFlags>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    ic->_masks[0] = 0x80000000;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch<b_branch___other__> *ic = new Inst_branch<b_branch___other__>;
    _instr_alloc_count++;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch<bc_branch___other__> *ic = new Inst_branch<bc_branch___other__>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::branchClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch<bclr_branch___other__> *ic = new Inst_branch<bclr_branch___other__>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::branchClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch<bl_branch___other__> *ic = new Inst_branch<bl_branch___other__>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::branchClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<cmp_sfx_Src1, cmp_sfx_Src2, cmp_sfx_SrcFlags, cmp_sfx_Trg, DummyOp> *ic = new Inst_sfx<cmp_sfx_Src1, cmp_sfx_Src2, cmp_sfx_SrcFlags, cmp_sfx_Trg, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    ic->_masks[0] = 0x80000000;
    return ic;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<cmpi_sfx_Src1, DummyOp, cmpi_sfx_SrcFlags, cmpi_sfx_Trg, DummyOp> *ic = new Inst_sfx<cmpi_sfx_Src1, DummyOp, cmpi_sfx_SrcFlags, cmpi_sfx_Trg, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, DummyOp, DummyOp, DummyOp, DummyOp> *ic = new Inst_sfx<DummyOp, DummyOp, DummyOp, DummyOp, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load<lbz_load_Imm, lbz_load_Src, lbz_load_Trg> *ic = new Inst_load<lbz_load_Imm, lbz_load_Src, lbz_load_Trg>;
    _instr_alloc_count++;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load<lhz_load_Imm, lhz_load_Src, lhz_load_Trg> *ic = new Inst_load<lhz_load_Imm, lhz_load_Src, lhz_load_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::loadClass,p);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load<lwz_load_Imm, lwz_load_Src, lwz_load_Trg> *ic = new Inst_load<lwz_load_Imm, lwz_load_Src, lwz_load_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::loadClass,p);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load<lwzu_load_Imm, lwzu_load_Src, lwzu_load_Trg> *ic = new Inst_load<lwzu_load_Imm, lwzu_load_Src, lwzu_load_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::loadClass,p);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load<DummyOp, lwzx_load_Src, lwzx_load_Trg> *ic = new Inst_load<DummyOp, lwzx_load_Src, lwzx_load_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::loadClass,p);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<mfspr_sfx_Src1, DummyOp, DummyOp, mfspr_sfx_Trg, DummyOp> *ic = new Inst_sfx<mfspr_sfx_Src1, DummyOp, DummyOp, mfspr_sfx_Trg, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  Inst_P *OSM_P::get_instr_mtspr(void *x)
  {
    ...
    if ((_iss->get_SPRN(p->_opc[0]) == 51)) {
      Inst_mtspr_hid<mtspr_mtspr_hid_Src, mtspr_mtspr_hid_Trg, mtspr_mtspr_hid___other__> *ic = new Inst_mtspr_hid<mtspr_mtspr_hid_Src, mtspr_mtspr_hid_Trg, mtspr_mtspr_hid___other__>;
      _instr_alloc_count++;
    ...
    Inst_sfx<mtspr_sfx_Src1, DummyOp, mtspr_sfx_SrcFlags, mtspr_sfx_Trg, DummyOp> *ic = new Inst_sfx<mtspr_sfx_Src1, DummyOp, mtspr_sfx_SrcFlags, mtspr_sfx_Trg, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    ic->_masks[0] = 0x400000;
    return ic;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<mullw_sfx_Src1, mullw_sfx_Src2, DummyOp, mullw_sfx_Trg, DummyOp> *ic = new Inst_sfx<mullw_sfx_Src1, mullw_sfx_Src2, DummyOp, mullw_sfx_Trg, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<or_sfx_Src1, or_sfx_Src2, DummyOp, or_sfx_Trg, DummyOp> *ic = new Inst_sfx<or_sfx_Src1, or_sfx_Src2, DummyOp, or_sfx_Trg, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<ori_sfx_Src1, DummyOp, DummyOp, ori_sfx_Trg, DummyOp> *ic = new Inst_sfx<ori_sfx_Src1, DummyOp, DummyOp, ori_sfx_Trg, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_rfi<rfi_rfi___other__> *ic = new Inst_rfi<rfi_rfi___other__>;
    _instr_alloc_count++;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<rlwinm_sfx_Src1, DummyOp, DummyOp, rlwinm_sfx_Trg, DummyOp> *ic = new Inst_sfx<rlwinm_sfx_Src1, DummyOp, DummyOp, rlwinm_sfx_Trg, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<srw_sfx_Src1, srw_sfx_Src2, DummyOp, srw_sfx_Trg, DummyOp> *ic = new Inst_sfx<srw_sfx_Src1, srw_sfx_Src2, DummyOp, srw_sfx_Trg, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    ic->_masks[4] = 0x1f;
    return ic;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store<stwu_store_Src, stwu_store_Trg> *ic = new Inst_store<stwu_store_Src, stwu_store_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::storeClass,p);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<tw_sfx_Src1, tw_sfx_Src2, DummyOp, DummyOp, DummyOp> *ic = new Inst_sfx<tw_sfx_Src1, tw_sfx_Src2, DummyOp, DummyOp, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_decode_miss<decode_miss_decode_miss___other__> *ic = new Inst_decode_miss<decode_miss_decode_miss___other__>;
    _instr_alloc_count++;
