...
namespace uadl {
  ...
  struct Inst_cache : public Inst_P {
    ...
    typedef struct Inst_cache<Src_t> ThisClass;
  ...
  struct Inst_load : public Inst_P {
    ...
    bool change_state_S_WBp__S_WBe(OSM_P &uarch,Logger *logger,unsigned position) {
      if (logger && uarch.logOsm()) { logger->logMessage("S_WBp -> S_WBe"); }
      _action = (StateFunc)action_S_WBe_p;
      _flush = (FlushFunc)flush_S_WBe_p;
      return action_S_WBe(uarch,logger,position);
    }
  ...
  Cache(
      ...
      1, // allow bus wait
      0, // pre-emptive
      CacheConfigMap(&_sym1041[0],&_sym1041[12]),
      1  // with-data
    ),
    _uarch(uarch)
  {
  ...
  byte_t* L2_cache_t::cachePosition(unsigned set, unsigned way, unsigned offset) const
  {
    return _uarch._iss->L2_cache_data_array(set, way) + offset;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_cache<dcba_cache_Src> *ic = (Inst_cache<dcba_cache_Src>*)_instr_pool.alloc();
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_cache<dcbf_cache_Src> *ic = (Inst_cache<dcbf_cache_Src>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::cacheClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_cache<dcbi_cache_Src> *ic = (Inst_cache<dcbi_cache_Src>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::cacheClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_cache<dcbst_cache_Src> *ic = (Inst_cache<dcbst_cache_Src>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::cacheClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_cache<dcbt_cache_Src> *ic = (Inst_cache<dcbt_cache_Src>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::cacheClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_cache<dcbz_cache_Src> *ic = (Inst_cache<dcbz_cache_Src>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::cacheClass,p);
    return ic;
  }
