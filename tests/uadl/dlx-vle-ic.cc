...
#  define ADL_HEADER
#endif
#include "dlx-vle-ic-iss.cc"
#define _OSM_P_IMPLEMENTATION_H
#include "dlx-vle-ic.h"
...
namespace uadl {
  ...
  struct se_add_sfx_Src1 {
    ...
    bool read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      ic._instr->read_operand(uarch.get_iss(),0);
      if (logger)logger->logOpAction("read",static_cast<OSM_P&>(uarch).rGPR.name(),ic.op(0)._index,ic._instr->slot(0).uint64());
      ic._instr->read_operand(uarch.get_iss(),1);
      if (logger)logger->logOpAction("read",static_cast<OSM_P&>(uarch).rGPR.name(),ic.op(1)._index,ic._instr->slot(1).uint64());
      return true;
    }
    
    void log_read(UadlArch &uarch,Inst_P &ic,Logger *logger,const string &msg) {
      logger->logOpAction(msg,static_cast<OSM_P&>(uarch).rGPR.name(),ic.op(0)._index,ic._instr->slot(0).uint64());
      logger->logOpAction(msg,static_cast<OSM_P&>(uarch).rGPR.name(),ic.op(1)._index,ic._instr->slot(1).uint64());
    }
    ...
    void log_read(UadlArch &uarch,Inst_P &ic,Logger *logger,const string &msg,unsigned sub_op) {
      switch (sub_op) {
        case 0: logger->logOpAction(msg,static_cast<OSM_P&>(uarch).rGPR.name(),ic.op(0)._index,ic._instr->slot(0).uint64());
        break;
        case 1: logger->logOpAction(msg,static_cast<OSM_P&>(uarch).rGPR.name(),ic.op(1)._index,ic._instr->slot(1).uint64());
        break;
      }
    }
  ...
  struct se_add_sfx_Trg {
    ...
    void write(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      deallocate(uarch,ic,logger);
      ic._instr->commit(uarch.get_iss(),0);
      if (logger)logger->logOpAction("write",static_cast<OSM_P&>(uarch).rGPR.name(),ic.op(0)._index,ic._instr->slot(0).uint64());
    }
  ...
  struct se_slw_sfx_Src1 {
    ...
    void read(OSM_P &uarch,Inst_P &ic,Logger *logger,T0 &t0,T1 &t1) {
      ...
      {
        read(uarch,ic,logger,1);
        if (t0.can_read_partial(uarch,ic,logger,static_cast<OSM_P&>(uarch).rGPR.id(static_cast<OSM_P&>(uarch),ic.op(1)._index)).first != 0) {
          t0.read_partial(uarch,ic,logger,*this,1);
          if (logger) log_read(uarch,ic,logger,"read from "+t0.name(),1);
        }
        if (t1.can_read_partial(uarch,ic,logger,static_cast<OSM_P&>(uarch).rGPR.id(static_cast<OSM_P&>(uarch),ic.op(1)._index)).first != 0) {
  ...
  struct subf__sfx_Flags {
    ...
    bool read(OSM_P &uarch,Inst_P &ic,Logger *logger,unsigned sub_op) {
      switch (sub_op) {
        case 0: break;
        case 1: ic._instr->read_operand(uarch.get_iss(),4);
        if (logger)logger->logOpAction("read",static_cast<OSM_P&>(uarch).XER.name(),-1,ic._instr->slot(4).uint64());
        break;
      }
      return true;
    ...
    void log_read(UadlArch &uarch,Inst_P &ic,Logger *logger,const string &msg,unsigned sub_op) {
      switch (sub_op) {
        case 0: break;
        case 1: logger->logOpAction(msg,static_cast<OSM_P&>(uarch).XER.name(),-1,ic._instr->slot(4).uint64());
        break;
      }
    }
  ...
  Inst_P *OSM_P::get_instr_add(void *x)
  {
    ...
    Inst_sfx<DummyOp, add_sfx_Src1, add_sfx_Src2, add_sfx_Trg> *ic = new Inst_sfx<DummyOp, add_sfx_Src1, add_sfx_Src2, add_sfx_Trg>;
    _instr_alloc_count++;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, addi_sfx_Src1, DummyOp, addi_sfx_Trg> *ic = new Inst_sfx<DummyOp, addi_sfx_Src1, DummyOp, addi_sfx_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, crand_sfx_Src1, DummyOp, crand_sfx_Trg> *ic = new Inst_sfx<DummyOp, crand_sfx_Src1, DummyOp, crand_sfx_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, DummyOp, DummyOp, DummyOp> *ic = new Inst_sfx<DummyOp, DummyOp, DummyOp, DummyOp>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, se_add_sfx_Src1, DummyOp, se_add_sfx_Trg> *ic = new Inst_sfx<DummyOp, se_add_sfx_Src1, DummyOp, se_add_sfx_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch<se_bc_branch___other__> *ic = new Inst_branch<se_bc_branch___other__>;
    _instr_alloc_count++;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, se_or_sfx_Src1, DummyOp, se_or_sfx_Trg> *ic = new Inst_sfx<DummyOp, se_or_sfx_Src1, DummyOp, se_or_sfx_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, se_slw_sfx_Src1, DummyOp, se_slw_sfx_Trg> *ic = new Inst_sfx<DummyOp, se_slw_sfx_Src1, DummyOp, se_slw_sfx_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    ic->_masks[0] = 0x3f;
    return ic;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, srw_sfx_Src1, srw_sfx_Src2, srw_sfx_Trg> *ic = new Inst_sfx<DummyOp, srw_sfx_Src1, srw_sfx_Src2, srw_sfx_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    ic->_masks[0] = 0x1f;
    return ic;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<subf__sfx_Flags, subf__sfx_Src1, subf__sfx_Src2, subf__sfx_Trg> *ic = new Inst_sfx<subf__sfx_Flags, subf__sfx_Src1, subf__sfx_Src2, subf__sfx_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    ...
    try {
      ...
      if (prefetchStatus != adl::prException) {
        switch (size) {
          case 2:
          do {
            prefetchStatus = _iss->prefetch<2>(ea);
