...
namespace uadl {
  ...
  _stage_loggers(8), 
  top(*this), 
  t0(id, thread_id, out, startTime, mEX, mID, mMM, mWB, Mem_obj, L1d_obj, L1i_obj, BARs, BootAddr, CBTEST2, CCR, FOOs, HID0, LoadStoreCount, LoadStoreIndex, MSRs, NIAs, TCR, TEN, all_stall, hid_stall, FwdEX, FwdMM, _stall, *this,static_cast<ISS_PMT_Thread*>(_iss->t0)), 
  t1(id, thread_id, out, startTime, mEX, mID, mMM, mWB, Mem_obj, L1d_obj, L1i_obj, BARs, BootAddr, CBTEST2, CCR, FOOs, HID0, LoadStoreCount, LoadStoreIndex, MSRs, NIAs, TCR, TEN, all_stall, hid_stall, FwdEX, FwdMM, _stall, *this,static_cast<ISS_PMT_Thread*>(_iss->t1))
  {
    L1d_obj.set_level(0);
    L1i_obj.set_level(0);
  };
