...
#  define ADL_HEADER
#endif
#include "dlx-cache-split2-safe-iss.cc"
#define _OSM_P_IMPLEMENTATION_H
#include "dlx-cache-split2-safe.h"
...
namespace uadl {
  ...
  Cache(
      ...
      0, // allow bus wait
      0, // pre-emptive
      CacheConfigMap(&_sym921[0],&_sym921[12]),
      0  // with-data
    ),
    _uarch(uarch)
  {
  ...
  static CacheConfigMap::value_type _sym922[] = {
    CacheConfigMap::value_type("critical_word_first",CacheConfigItem(1)),
    CacheConfigMap::value_type("invalidate_latency",CacheConfigItem(1)),
    CacheConfigMap::value_type("linefill_access_width",CacheConfigItem(64)),
    CacheConfigMap::value_type("linefill_lock_holdoff_cycle",CacheConfigItem(1)),
  ...
  Cache(
      ...
      1, // allow bus wait
      0, // pre-emptive
      CacheConfigMap(&_sym922[0],&_sym922[12]),
      0  // with-data
    ),
    _uarch(uarch)
  {
