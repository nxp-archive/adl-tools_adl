...
namespace uadl {
  ...
  // Operand Alias:  lbz_load_Src1 -> lhz_load_Src1
  //   (src: GPR(RA))
  typedef lbz_load_Src1 lhz_load_Src1;
  ...
  // Operand Alias:  lbz_load_Src1 -> lwz_load_Src1
  //   (src: GPR(RA))
  typedef lbz_load_Src1 lwz_load_Src1;
  
  // Operand Alias:  lbz_load_Trg -> lwz_load_Trg
  //   (trg: GPR(RT))
  typedef lbz_load_Trg lwz_load_Trg;
  
  // Operand Alias:  lbz_load_Src1 -> lwzx_load_Src1
  //   (src: GPR(RA))
  typedef lbz_load_Src1 lwzx_load_Src1;
  
  // Operands:
  //   (src: GPR(RB))
  struct lwzx_load_Src2 {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
    }
  ...
  // Operands:
  //   (src: GPR(RA . uint32 (  )), trg: GPR(RA . uint32 (  )))
  struct lwzu_load_update_Src1 {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      return true;
    }
  ...
  // Operand Alias:  cror_sfx_Src1 -> cror_sfx_Trg
  //   (src: CR/p, trg: CR/p)
  typedef cror_sfx_Src1 cror_sfx_Trg;
  
  // Operand Alias:  cror_sfx_Src1 -> crand_sfx_Src1
  //   (src: CR/p, trg: CR/p)
  typedef cror_sfx_Src1 crand_sfx_Src1;
  
  // Operand Alias:  cror_sfx_Src1 -> crand_sfx_Trg
  //   (src: CR/p, trg: CR/p)
  typedef cror_sfx_Src1 crand_sfx_Trg;
  
  // Operand Alias:  addi_sfx_Src1 -> mulli_sfx_Src1
  //   (src: GPR(RA))
  typedef addi_sfx_Src1 mulli_sfx_Src1;
      ...
      for (int i = 1; i != 33; ++i) {
        if  (ic.op(i).isSrc()) {
          ...
          if (t0.can_read(uarch,ic,logger,id,tag)) {
            ...
            t1.read(uarch,ic,logger,*this,1,i);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<addic__sfx_Flags, addic__sfx_Src1, DummyOp, addic__sfx_Trg> *ic = (Inst_sfx<addic__sfx_Flags, addic__sfx_Src1, DummyOp, addic__sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, addis_sfx_Src1, DummyOp, addis_sfx_Trg> *ic = (Inst_sfx<DummyOp, addis_sfx_Src1, DummyOp, addis_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<andi__sfx_Flags, andi__sfx_Src1, DummyOp, andi__sfx_Trg> *ic = (Inst_sfx<andi__sfx_Flags, andi__sfx_Src1, DummyOp, andi__sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    ic->_masks[0] = 0xf0000000;
    ic->_masks[1] = 0x80000000;
    return ic;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<cmp_sfx_Flags, cmp_sfx_Src1, cmp_sfx_Src2, cmp_sfx_Trg> *ic = (Inst_sfx<cmp_sfx_Flags, cmp_sfx_Src1, cmp_sfx_Src2, cmp_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<cmpi_sfx_Flags, cmpi_sfx_Src1, DummyOp, cmpi_sfx_Trg> *ic = (Inst_sfx<cmpi_sfx_Flags, cmpi_sfx_Src1, DummyOp, cmpi_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, cror_sfx_Src1, DummyOp, cror_sfx_Trg> *ic = (Inst_sfx<DummyOp, cror_sfx_Src1, DummyOp, cror_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load<lbz_load_Imm, lbz_load_Src1, DummyOp, lbz_load_Trg> *ic = (Inst_load<lbz_load_Imm, lbz_load_Src1, DummyOp, lbz_load_Trg>*)_instr_pool.alloc();
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load<lhz_load_Imm, lhz_load_Src1, DummyOp, lhz_load_Trg> *ic = (Inst_load<lhz_load_Imm, lhz_load_Src1, DummyOp, lhz_load_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::loadClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load<lwz_load_Imm, lwz_load_Src1, DummyOp, lwz_load_Trg> *ic = (Inst_load<lwz_load_Imm, lwz_load_Src1, DummyOp, lwz_load_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::loadClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load_update<lwzu_load_update_Src1, DummyOp, lwzu_load_update_Trg> *ic = (Inst_load_update<lwzu_load_update_Src1, DummyOp, lwzu_load_update_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::load_updateClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load<DummyOp, lwzx_load_Src1, lwzx_load_Src2, lwzx_load_Trg> *ic = (Inst_load<DummyOp, lwzx_load_Src1, lwzx_load_Src2, lwzx_load_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::loadClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, mfspr_sfx_Src1, DummyOp, mfspr_sfx_Trg> *ic = (Inst_sfx<DummyOp, mfspr_sfx_Src1, DummyOp, mfspr_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    if ((_iss->get_SPRN(p->_opc[0]) == 200)) {
      Inst_mtspr_foo<mtspr_mtspr_foo_Src, mtspr_mtspr_foo_Trg> *ic = (Inst_mtspr_foo<mtspr_mtspr_foo_Src, mtspr_mtspr_foo_Trg>*)_instr_pool.alloc();
      ic->reset(_issueId++,_commits,adliss::P::mtspr_fooClass,p);
      return ic;
    }
    Inst_sfx<DummyOp, mtspr_sfx_Src1, DummyOp, mtspr_sfx_Trg> *ic = (Inst_sfx<DummyOp, mtspr_sfx_Src1, DummyOp, mtspr_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, mulli_sfx_Src1, DummyOp, mulli_sfx_Trg> *ic = (Inst_sfx<DummyOp, mulli_sfx_Src1, DummyOp, mulli_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, mullw_sfx_Src1, mullw_sfx_Src2, mullw_sfx_Trg> *ic = (Inst_sfx<DummyOp, mullw_sfx_Src1, mullw_sfx_Src2, mullw_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, or_sfx_Src1, or_sfx_Src2, or_sfx_Trg> *ic = (Inst_sfx<DummyOp, or_sfx_Src1, or_sfx_Src2, or_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, ori_sfx_Src1, DummyOp, ori_sfx_Trg> *ic = (Inst_sfx<DummyOp, ori_sfx_Src1, DummyOp, ori_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, rlwinm_sfx_Src1, DummyOp, rlwinm_sfx_Trg> *ic = (Inst_sfx<DummyOp, rlwinm_sfx_Src1, DummyOp, rlwinm_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_stmw<stmw_stmw_Src, DummyOp> *ic = (Inst_stmw<stmw_stmw_Src, DummyOp>*)_instr_pool.alloc();
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store_update<stwu_store_update_Src, stwu_store_update_Trg> *ic = (Inst_store_update<stwu_store_update_Src, stwu_store_update_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::store_updateClass,p);
    return ic;
  }
  ...
  FwdEX("FwdEX"), 
  FwdMM("FwdMM"), 
  Fetcher(*this,getPath(_iss,".")+"Fetcher",2,mMEM_obj,0,_fetchSizes,&mMEM_obj), 
  _cur_instr(0), 
  _ignore_mem(false), 
  Issue("         "), 
  _stall(false), 
