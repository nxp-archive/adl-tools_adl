...
namespace uadl {
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch<DummyOp, b_branch_Src, b_branch_Trg> *ic = new Inst_branch<DummyOp, b_branch_Src, b_branch_Trg>;
    _instr_alloc_count++;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch<DummyOp, bc_branch_Src, bc_branch_Trg> *ic = new Inst_branch<DummyOp, bc_branch_Src, bc_branch_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::branchClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch_return<bclr_branch_return_Src, bclr_branch_return_Trg> *ic = new Inst_branch_return<bclr_branch_return_Src, bclr_branch_return_Trg>;
    _instr_alloc_count++;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch<bl_branch_LinkStackUpdate, bl_branch_Src, bl_branch_Trg> *ic = new Inst_branch<bl_branch_LinkStackUpdate, bl_branch_Src, bl_branch_Trg>;
    _instr_alloc_count++;
    ic->reset(_issueId++,_commits,adliss::P::branchClass,p);
    return ic;
  }
