...
#  define ADL_HEADER
#endif
#include "dlx2-fwd-vd-iss.cc"
#define _OSM_P_IMPLEMENTATION_H
#include "dlx2-fwd-vd.h"
...
namespace uadl {
  ...
  struct branch_Src : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
    
    virtual bits<32> value(OSM_P &,Inst_P &,Logger *) const { return 0; }
    
    virtual bool can_read_fp(OSM_P &uarch,Inst_P &ic,Logger *logger,ForwardingPath<Inst_P,0,0,4,32> &t0) {
      return true;
    }
    
    virtual bool can_read_fp(OSM_P &uarch,Inst_P &ic,Logger *logger,ForwardingPath<Inst_P,0,0,4,32> &t0,ForwardingPath<Inst_P,0,0,4,32> &t1) {
      return true;
    }
    
    using DummyOp::read;
    virtual void read(OSM_P &uarch,Inst_P &ic,Logger *logger,ForwardingPath<Inst_P,0,0,4,32> &t0) {
    }
    
    virtual void read(OSM_P &uarch,Inst_P &ic,Logger *logger,ForwardingPath<Inst_P,0,0,4,32> &t0,ForwardingPath<Inst_P,0,0,4,32> &t1) {
    }
    
    bool read_avail(OSM_P &uarch,Inst_P &ic,Logger *logger,ForwardingPath<Inst_P,0,0,4,32> &t0) {
      return true;
    }
    
    bool read_avail(OSM_P &uarch,Inst_P &ic,Logger *logger,ForwardingPath<Inst_P,0,0,4,32> &t0,ForwardingPath<Inst_P,0,0,4,32> &t1) {
      return true;
    }
    
  };
  
  static branch_Src branch_Src_v;
  
  struct branch_Trg : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static branch_Trg branch_Trg_v;
  ...
  //   (src: CR/p)
  //   (src: CTR?)
  struct bc_branch_Src : public branch_Src {
    ...
    bool can_read_fp(OSM_P &uarch,Inst_P &ic,Logger *logger,ForwardingPath<Inst_P,0,0,4,32> &t0,ForwardingPath<Inst_P,0,0,4,32> &t1) {
      {
    ...
    void read(OSM_P &uarch,Inst_P &ic,Logger *logger,ForwardingPath<Inst_P,0,0,4,32> &t0,ForwardingPath<Inst_P,0,0,4,32> &t1) {
      {
        RegId id = static_cast<OSM_P&>(uarch).CIA.id(static_cast<OSM_P&>(uarch),0);
        tag_t tag = (static_cast<OSM_P&>(uarch).CIA.last_allocator( static_cast<OSM_P&>(uarch),0));
  ...
  static bc_branch_Src bc_branch_Src_v;
  
  // Operands:
  //   (trg: CTR?)
  //   (trg: NIA?)
  struct bc_branch_Trg : public branch_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.CTR.can_alloc(uarch,ic,logger,"read")) return false;
  ...
  static bc_branch_Trg bc_branch_Trg_v;
  
  // Operands:
  //   (src: CIA)
  struct b_branch_Src : public branch_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.CIA.can_alloc(uarch,ic,logger,"read")) return false;
      return true;
    }
  ...
  static b_branch_Src b_branch_Src_v;
  
  // Operands:
  //   (trg: NIA)
  struct b_branch_Trg : public branch_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.NIA.can_alloc(uarch,ic,logger,"read")) return false;
      return true;
    }
  ...
  static b_branch_Trg b_branch_Trg_v;
  
  // Operand Alias:  b_branch_Src -> bl_branch_Src
  //   (src: CIA)
  typedef b_branch_Src bl_branch_Src;
  
  static bl_branch_Src bl_branch_Src_v;
  
  // Operands:
  //   (trg: LR)
  //   (trg: NIA)
  struct bl_branch_Trg : public branch_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static bl_branch_Trg bl_branch_Trg_v;
  
  // Operands:
  //   (src: CR/p)
  //   (src: CTR?)
  //   (src: LR?)
  struct bclr_branch_Src : public branch_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.CR.can_alloc(uarch,ic,logger,"read")) return false;
      if (!uarch.CTR.can_alloc(uarch,ic,logger,"read")) return false;
      if (!uarch.LR.can_alloc(uarch,ic,logger,"read")) return false;
  ...
  static bclr_branch_Src bclr_branch_Src_v;
  
  // Operands:
  //   (trg: CTR?)
  //   (trg: NIA?)
  struct bclr_branch_Trg : public branch_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.CTR.can_alloc(uarch,ic,logger,"read")) return false;
      if (!uarch.NIA.can_alloc(uarch,ic,logger,"read")) return false;
      return true;
  ...
  static bclr_branch_Trg bclr_branch_Trg_v;
  ...
  struct Inst_branch : public Inst_P {
    ...
    Inst_branch(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, branch_Src &Src_p, branch_Trg &Trg_p) : Src(Src_p), Trg(Trg_p)
    {
  ...
  struct decode_miss_Src : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static decode_miss_Src decode_miss_Src_v;
  
  struct decode_miss_Trg : public DummyOp {
  ...
  static decode_miss_Trg decode_miss_Trg_v;
  ...
  // Operands:
  //   (src: ESR)
  struct decode_miss_decode_miss_Src : public decode_miss_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static decode_miss_decode_miss_Src decode_miss_decode_miss_Src_v;
  ...
  struct Inst_decode_miss : public Inst_P {
    ...
    typedef struct Inst_decode_miss ThisClass;
    ...
    Inst_decode_miss(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, decode_miss_Src &Src_p, decode_miss_Trg &Trg_p) : Src(Src_p), Trg(Trg_p)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  struct Inst_fetch_exception : public Inst_P {
    ...
    Inst_fetch_exception(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  struct Inst_isync : public Inst_P {
    ...
    Inst_isync(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  static lmw_Src lmw_Src_v;
  
  struct lmw_Trg : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  struct lmw_lmw_Src : public lmw_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static lmw_lmw_Src lmw_lmw_Src_v;
  
  // Operands:
  //   (trg: GPR(RT . uint32 (  ),31))
  struct lmw_lmw_Trg : public lmw_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      for (int i = 4; i != 36; ++i) {
  ...
  static lmw_lmw_Trg lmw_lmw_Trg_v;
  ...
  struct Inst_lmw : public Inst_P {
    ...
    typedef struct Inst_lmw ThisClass;
    ...
    Inst_lmw(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, lmw_Src &Src_p, lmw_Trg &Trg_p) : Src(Src_p), Trg(Trg_p)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  struct load_TrgEA : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static load_TrgEA load_TrgEA_v;
  ...
  // Operands:
  //   (trg: GPR(RA . uint32 (  )))
  struct lwzu_load_TrgEA : public load_TrgEA {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(3)._index,"read")) return false;
      return true;
    }
  ...
  static lwzu_load_TrgEA lwzu_load_TrgEA_v;
  ...
  struct Inst_load : public Inst_P {
    ...
    Inst_load(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, load_Src &Src_p, load_Trg &Trg_p, load_TrgEA &TrgEA_p) : Src(Src_p), Trg(Trg_p), TrgEA(TrgEA_p)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  struct mtmsr_Src : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static mtmsr_Src mtmsr_Src_v;
  
  struct mtmsr_Trg : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  // Operands:
  //   (src: GPR(RS))
  struct mtmsr_mtmsr_Src : public mtmsr_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static mtmsr_mtmsr_Src mtmsr_mtmsr_Src_v;
  
  // Operands:
  //   (trg: MSR)
  struct mtmsr_mtmsr_Trg : public mtmsr_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static mtmsr_mtmsr_Trg mtmsr_mtmsr_Trg_v;
  ...
  struct Inst_mtmsr : public Inst_P {
    ...
    typedef struct Inst_mtmsr ThisClass;
    ...
    Inst_mtmsr(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, mtmsr_Src &Src_p, mtmsr_Trg &Trg_p) : Src(Src_p), Trg(Trg_p)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  struct mtspr_hid_Src : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static mtspr_hid_Src mtspr_hid_Src_v;
  
  struct mtspr_hid_Trg : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static mtspr_hid_Trg mtspr_hid_Trg_v;
  ...
  struct mtspr_mtspr_hid_Src : public mtspr_hid_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
  ...
  static mtspr_mtspr_hid_Src mtspr_mtspr_hid_Src_v;
  
  // Operands:
  //   (trg: SPR(SPRN))
  struct mtspr_mtspr_hid_Trg : public mtspr_hid_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static mtspr_mtspr_hid_Trg mtspr_mtspr_hid_Trg_v;
  ...
  struct Inst_mtspr_hid : public Inst_P {
    ...
    typedef struct Inst_mtspr_hid ThisClass;
    ...
    Inst_mtspr_hid(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, mtspr_hid_Src &Src_p, mtspr_hid_Trg &Trg_p) : Src(Src_p), Trg(Trg_p)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  struct muldiv_Src : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static muldiv_Src muldiv_Src_v;
  
  struct muldiv_Trg : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static muldiv_Trg muldiv_Trg_v;
  ...
  // Operands:
  //   (src: GPR(RA))
  struct mulli_muldiv_Src : public muldiv_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      return true;
    }
  ...
  static mulli_muldiv_Src mulli_muldiv_Src_v;
  
  // Operands:
  //   (trg: GPR(RT))
  struct mulli_muldiv_Trg : public muldiv_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static mulli_muldiv_Trg mulli_muldiv_Trg_v;
  
  // Operands:
  //   (src: GPR(RA))
  //   (src: GPR(RB))
  struct mullw_muldiv_Src : public muldiv_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
  ...
  static mullw_muldiv_Src mullw_muldiv_Src_v;
  
  // Operands:
  //   (trg: GPR(RT))
  struct mullw_muldiv_Trg : public muldiv_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static mullw_muldiv_Trg mullw_muldiv_Trg_v;
  ...
  struct Inst_muldiv : public Inst_P {
    ...
    typedef struct Inst_muldiv ThisClass;
    ...
    Inst_muldiv(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, muldiv_Src &Src_p, muldiv_Trg &Trg_p) : Src(Src_p), Trg(Trg_p)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  struct nop___other__ : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static nop___other__ nop___other___v;
  ...
  //   (trg: GPR(RA))
  //   (src: GPR(RS))
  struct ori_nop___other__ : public nop___other__ {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
  ...
  static ori_nop___other__ ori_nop___other___v;
  ...
  struct Inst_nop : public Inst_P {
    ...
    typedef struct Inst_nop ThisClass;
    
    Inst_nop &thisInstr() { return *this; };
    
    nop___other__ &__other__;
    
    Inst_nop(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, nop___other__ &__other___p) : __other__(__other___p)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  static rfi_Src rfi_Src_v;
  
  struct rfi_Trg : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  //   (src: SRR0)
  //   (src: SRR1)
  struct rfi_rfi_Src : public rfi_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static rfi_rfi_Src rfi_rfi_Src_v;
  
  // Operands:
  //   (trg: MSR)
  //   (trg: NIA)
  struct rfi_rfi_Trg : public rfi_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.MSR.can_alloc(uarch,ic,logger,"read")) return false;
      if (!uarch.NIA.can_alloc(uarch,ic,logger,"read")) return false;
      return true;
  ...
  static rfi_rfi_Trg rfi_rfi_Trg_v;
  ...
  struct Inst_rfi : public Inst_P {
    ...
    typedef struct Inst_rfi ThisClass;
    ...
    Inst_rfi(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, rfi_Src &Src_p, rfi_Trg &Trg_p) : Src(Src_p), Trg(Trg_p)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  struct addic__sfx_Src : public sfx_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
  ...
  static addic__sfx_Src addic__sfx_Src_v;
  ...
  // Operands:
  //   (src: GPR(RA))
  struct addic_sfx_Src : public sfx_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      return true;
    }
  ...
  static addic_sfx_Src addic_sfx_Src_v;
  
  // Operands:
  //   (trg: GPR(RT))
  //   (trg: XER[mask 0x20000000]/p)
  struct addic_sfx_Trg : public sfx_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      if (!uarch.XER.can_alloc(uarch,ic,logger,"read", ic._masks[0])) return false;
      return true;
  ...
  static addis_sfx_Src addis_sfx_Src_v;
  ...
  struct addme_sfx_Src : public sfx_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
  ...
  static addme_sfx_Src addme_sfx_Src_v;
  ...
  static addme_sfx_Trg addme_sfx_Trg_v;
  ...
  static addme__sfx_Src addme__sfx_Src_v;
  ...
  static addme__sfx_Trg addme__sfx_Trg_v;
  ...
  static addmeo_sfx_Src addmeo_sfx_Src_v;
  ...
  static addmeo_sfx_Trg addmeo_sfx_Trg_v;
  
  // Operands:
  //   (src: GPR(RA))
  //   (src: GPR(RB))
  //   (src: XER[mask 0xc0000000]/p)
  struct addo_sfx_Src : public sfx_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      if (!uarch.XER.can_alloc(uarch,ic,logger,"read", ic._masks[0])) return false;
  ...
  static addo_sfx_Src addo_sfx_Src_v;
  
  // Operands:
  //   (trg: GPR(RT))
  //   (trg: XER[mask 0xc0000000]/p)
  struct addo_sfx_Trg : public sfx_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(2)._index,"read")) return false;
      if (!uarch.XER.can_alloc(uarch,ic,logger,"read", ic._masks[1])) return false;
      return true;
  ...
  static addo_sfx_Trg addo_sfx_Trg_v;
  
  // Operands:
  //   (src: GPR(RS))
  struct ori_sfx_Src : public sfx_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
    }
  ...
  static ori_sfx_Src ori_sfx_Src_v;
  ...
  //   (src: GPR(RS))
  //   (src: XER[mask 0x80000000]/p)
  struct andi__sfx_Src : public sfx_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(2)._index,"read")) return false;
      if (!uarch.XER.can_alloc(uarch,ic,logger,"read", ic._masks[0])) return false;
      return true;
  ...
  static andi__sfx_Src andi__sfx_Src_v;
  ...
  static rlwinm_sfx_Src rlwinm_sfx_Src_v;
  ...
  //   (src: GPR(RA))
  //   (src: GPR(RB))
  struct add_sfx_Src : public sfx_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
  ...
  static add_sfx_Src add_sfx_Src_v;
  
  // Operands:
  //   (trg: GPR(RT))
  struct add_sfx_Trg : public sfx_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(2)._index,"read")) return false;
      return true;
    }
  ...
  //   (src: GPR(RA))
  //   (src: XER[mask 0x80000000]/p)
  struct cmpi_sfx_Src : public sfx_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      if (!uarch.XER.can_alloc(uarch,ic,logger,"read", ic._masks[0])) return false;
      return true;
  ...
  static cmpi_sfx_Src cmpi_sfx_Src_v;
  ...
  //   (src: GPR(RB))
  //   (src: XER[mask 0x80000000]/p)
  struct cmp_sfx_Src : public sfx_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(2)._index,"read")) return false;
      if (!uarch.XER.can_alloc(uarch,ic,logger,"read", ic._masks[1])) return false;
  ...
  static cmp_sfx_Src cmp_sfx_Src_v;
  ...
  //   (src: GPR(RB))
  //   (src: GPR(RS))
  struct or_sfx_Src : public sfx_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(2)._index,"read")) return false;
      return true;
  ...
  static or_sfx_Src or_sfx_Src_v;
  ...
  // Operands:
  //   (src: SPR(SPRN))
  struct mfspr_sfx_Src : public sfx_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static mfspr_sfx_Src mfspr_sfx_Src_v;
  ...
  //   (src: GPR(RS))
  struct srw_sfx_Src : public sfx_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static srw_sfx_Src srw_sfx_Src_v;
  ...
  //   (src: GPR(RS))
  //   (src: MSR[mask 0x00400000]/p)
  struct mtspr_sfx_Src : public sfx_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      if (!uarch.MSR.can_alloc(uarch,ic,logger,"read", ic._masks[0])) return false;
      return true;
  ...
  static mtspr_sfx_Src mtspr_sfx_Src_v;
  
  // Operands:
  //   (trg: SPR(SPRN))
  struct mtspr_sfx_Trg : public sfx_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.SPR.can_alloc(uarch,ic,logger,ic.op(2)._index,"read")) return false;
      return true;
    }
  ...
  static mtspr_sfx_Trg mtspr_sfx_Trg_v;
  ...
  static tw_sfx_Src tw_sfx_Src_v;
  ...
  struct Inst_sfx : public Inst_P {
    ...
    Inst_sfx(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, sfx_Src &Src_p, sfx_Trg &Trg_p) : Src(Src_p), Trg(Trg_p)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  struct stmw_Src : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static stmw_Src stmw_Src_v;
  
  struct stmw_SrcCR : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static stmw_SrcCR stmw_SrcCR_v;
  
  struct stmw_Trg : public DummyOp {
    virtual unsigned mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  //   (src: dsESR?)
  //   (src: dsFoo[mask 0xff000000]/p?)
  struct stmw_stmw_Src : public stmw_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.FOO.can_alloc(uarch,ic,logger,"read", ic._masks[0])) return false;
  ...
  static stmw_stmw_Src stmw_stmw_Src_v;
  
  // Operands:
  //   (src: CR, mask: 0xffffffff)
  struct stmw_stmw_SrcCR : public stmw_SrcCR {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static stmw_stmw_SrcCR stmw_stmw_SrcCR_v;
  ...
  struct Inst_stmw : public Inst_P {
    ...
    typedef struct Inst_stmw ThisClass;
    ...
    Inst_stmw(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, stmw_Src &Src_p, stmw_SrcCR &SrcCR_p, stmw_Trg &Trg_p) : Src(Src_p), SrcCR(SrcCR_p), Trg(Trg_p)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  struct store_TrgEA : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static store_TrgEA store_TrgEA_v;
  ...
  // Operands:
  //   (trg: GPR(RA))
  struct stwu_store_TrgEA : public store_TrgEA {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(3)._index,"read")) return false;
      return true;
    }
  ...
  static stwu_store_TrgEA stwu_store_TrgEA_v;
  ...
  struct Inst_store : public Inst_P {
    ...
    Inst_store(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, store_Src &Src_p, store_TrgEA &TrgEA_p) : Src(Src_p), TrgEA(TrgEA_p)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  Inst_P *OSM_P::get_instr_add(void *x)
  {
    ...
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,add_sfx_Src_v,add_sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,addi_sfx_Src_v,addi_sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,addic_sfx_Src_v,addic_sfx_Trg_v);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,addic__sfx_Src_v,addic__sfx_Trg_v);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,addis_sfx_Src_v,addis_sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,addme_sfx_Src_v,addme_sfx_Trg_v);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,addme__sfx_Src_v,addme__sfx_Trg_v);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,addmeo_sfx_Src_v,addmeo_sfx_Trg_v);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,addo_sfx_Src_v,addo_sfx_Trg_v);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,andi__sfx_Src_v,andi__sfx_Trg_v);
    ic->_masks[0] = 0x80000000;
    ic->_masks[1] = 0xf0000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch *ic = new (_instr_pool.alloc()) Inst_branch(_issueId++,_commits,adliss::P::branchClass,p,b_branch_Src_v,b_branch_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch *ic = new (_instr_pool.alloc()) Inst_branch(_issueId++,_commits,adliss::P::branchClass,p,bc_branch_Src_v,bc_branch_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch *ic = new (_instr_pool.alloc()) Inst_branch(_issueId++,_commits,adliss::P::branchClass,p,bclr_branch_Src_v,bclr_branch_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch *ic = new (_instr_pool.alloc()) Inst_branch(_issueId++,_commits,adliss::P::branchClass,p,bl_branch_Src_v,bl_branch_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,cmp_sfx_Src_v,cmp_sfx_Trg_v);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,cmpi_sfx_Src_v,cmpi_sfx_Trg_v);
    ic->_masks[0] = 0x80000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_isync *ic = new (_instr_pool.alloc()) Inst_isync(_issueId++,_commits,adliss::P::isyncClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load *ic = new (_instr_pool.alloc()) Inst_load(_issueId++,_commits,adliss::P::loadClass,p,lbz_load_Src_v,lbz_load_Trg_v,load_TrgEA_v);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load *ic = new (_instr_pool.alloc()) Inst_load(_issueId++,_commits,adliss::P::loadClass,p,lhz_load_Src_v,lhz_load_Trg_v,load_TrgEA_v);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_lmw *ic = new (_instr_pool.alloc()) Inst_lmw(_issueId++,_commits,adliss::P::lmwClass,p,lmw_lmw_Src_v,lmw_lmw_Trg_v);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load *ic = new (_instr_pool.alloc()) Inst_load(_issueId++,_commits,adliss::P::loadClass,p,lwz_load_Src_v,lwz_load_Trg_v,load_TrgEA_v);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load *ic = new (_instr_pool.alloc()) Inst_load(_issueId++,_commits,adliss::P::loadClass,p,lwzu_load_Src_v,lwzu_load_Trg_v,lwzu_load_TrgEA_v);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load *ic = new (_instr_pool.alloc()) Inst_load(_issueId++,_commits,adliss::P::loadClass,p,lwzx_load_Src_v,lwzx_load_Trg_v,load_TrgEA_v);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,mfspr_sfx_Src_v,mfspr_sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_mtmsr *ic = new (_instr_pool.alloc()) Inst_mtmsr(_issueId++,_commits,adliss::P::mtmsrClass,p,mtmsr_mtmsr_Src_v,mtmsr_mtmsr_Trg_v);
    return ic;
  }
  ...
  Inst_P *OSM_P::get_instr_mtspr(void *x)
  {
    ...
    if ((_iss->get_SPRN(p->_opc[0]) == 51)) {
      Inst_mtspr_hid *ic = new (_instr_pool.alloc()) Inst_mtspr_hid(_issueId++,_commits,adliss::P::mtspr_hidClass,p,mtspr_mtspr_hid_Src_v,mtspr_mtspr_hid_Trg_v);
      return ic;
    }
    ...
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,mtspr_sfx_Src_v,mtspr_sfx_Trg_v);
    ic->_masks[0] = 0x400000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_muldiv *ic = new (_instr_pool.alloc()) Inst_muldiv(_issueId++,_commits,adliss::P::muldivClass,p,mulli_muldiv_Src_v,mulli_muldiv_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_muldiv *ic = new (_instr_pool.alloc()) Inst_muldiv(_issueId++,_commits,adliss::P::muldivClass,p,mullw_muldiv_Src_v,mullw_muldiv_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,or_sfx_Src_v,or_sfx_Trg_v);
    return ic;
  }
  ...
  Inst_P *OSM_P::get_instr_ori(void *x)
  {
    ...
    if ((_iss->get_RA(p->_opc[0]) == 0) && (_iss->get_RS(p->_opc[0]) == 0) && (_iss->get_UI(p->_opc[0]) == 0)) {
      Inst_nop *ic = new (_instr_pool.alloc()) Inst_nop(_issueId++,_commits,adliss::P::nopClass,p,ori_nop___other___v);
      return ic;
    }
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,ori_sfx_Src_v,ori_sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_rfi *ic = new (_instr_pool.alloc()) Inst_rfi(_issueId++,_commits,adliss::P::rfiClass,p,rfi_rfi_Src_v,rfi_rfi_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,rlwinm_sfx_Src_v,rlwinm_sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,srw_sfx_Src_v,srw_sfx_Trg_v);
    ic->_masks[0] = 0x1f;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store *ic = new (_instr_pool.alloc()) Inst_store(_issueId++,_commits,adliss::P::storeClass,p,stb_store_Src_v,store_TrgEA_v);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store *ic = new (_instr_pool.alloc()) Inst_store(_issueId++,_commits,adliss::P::storeClass,p,sth_store_Src_v,store_TrgEA_v);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store *ic = new (_instr_pool.alloc()) Inst_store(_issueId++,_commits,adliss::P::storeClass,p,sthx_store_Src_v,store_TrgEA_v);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_stmw *ic = new (_instr_pool.alloc()) Inst_stmw(_issueId++,_commits,adliss::P::stmwClass,p,stmw_stmw_Src_v,stmw_stmw_SrcCR_v,stmw_Trg_v);
    ic->_masks[0] = 0x100000;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store *ic = new (_instr_pool.alloc()) Inst_store(_issueId++,_commits,adliss::P::storeClass,p,stw_store_Src_v,store_TrgEA_v);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store *ic = new (_instr_pool.alloc()) Inst_store(_issueId++,_commits,adliss::P::storeClass,p,stwu_store_Src_v,stwu_store_TrgEA_v);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store *ic = new (_instr_pool.alloc()) Inst_store(_issueId++,_commits,adliss::P::storeClass,p,stwx_store_Src_v,store_TrgEA_v);
    ic->_masks[0] = 0x100000;
    ic->_masks[1] = 0xff000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,tw_sfx_Src_v,sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_decode_miss *ic = new (_instr_pool.alloc()) Inst_decode_miss(_issueId++,_commits,adliss::P::decode_missClass,p,decode_miss_decode_miss_Src_v,decode_miss_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_fetch_exception *ic = new (_instr_pool.alloc()) Inst_fetch_exception(_issueId,_commits,adliss::P::fetch_exceptionClass,p);
    return ic;
  }
