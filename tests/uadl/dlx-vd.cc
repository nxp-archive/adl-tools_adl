...
namespace uadl {
  ...
  struct DummyOp {
    ...
    virtual bool can_read(OSM_P &,Inst_P &,Logger *) {
      return true;
    }
    
    virtual bool read(OSM_P &,Inst_P &,Logger *) {
      return false;
    }
    
    virtual void record_sources(OSM_P &,Inst_P &,Logger *) {}
    
    virtual void log_read(UadlArch &,Inst_P &,Logger *,const string &,unsigned) {
    }
    
    virtual bool can_write(OSM_P &,Inst_P &,Logger *) {
      return true;
    }
    
    virtual void allocate(OSM_P &,Inst_P &,Logger *) {
    }
    
    virtual void deallocate(OSM_P &,Inst_P &,Logger *) {
    }
    
    virtual void write(OSM_P &,Inst_P &,Logger *) {
    }
    virtual unsigned field_value(OSM_P &,Inst_P &,Logger *) const { return 0; }
    
    virtual bool is_real(OSM_P &,Inst_P &,Logger *) const { return false; }
    
    virtual std::string name(UadlArch &,Inst_P &,unsigned = 0,unsigned = 0) const { return std::string(); }
    
    virtual RegId id(UadlArch &,const Inst_P &,unsigned = 0,unsigned id = 0) const { return RegInvalidId; }
    
    virtual unsigned slot(unsigned = 0,unsigned = 0) const { return 0; }
    
    virtual unsigned num_sub_ops() const { return 0; }
    
  };
  
  struct branch___other__ : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
    
    virtual bits<32> value(OSM_P &,Inst_P &,Logger *) const { return 0; }
    
    using DummyOp::read;
  };
  
  static branch___other__ branch___other___v;
  ...
  //   (src: CTR?, trg: CTR?)
  //   (trg: NIA?)
  struct bc_branch___other__ : public branch___other__ {
  ...
  static bc_branch___other__ bc_branch___other___v;
  
  // Operands:
  //   (src: CIA)
  //   (trg: NIA)
  struct b_branch___other__ : public branch___other__ {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.CIA.can_alloc(uarch,ic,logger,"read")) return false;
      if (!uarch.NIA.can_alloc(uarch,ic,logger,"read")) return false;
      return true;
  ...
  static b_branch___other__ b_branch___other___v;
  
  // Operands:
  //   (src: CIA)
  //   (trg: LR)
  //   (trg: NIA)
  struct bl_branch___other__ : public branch___other__ {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.CIA.can_alloc(uarch,ic,logger,"read")) return false;
  ...
  static bl_branch___other__ bl_branch___other___v;
  ...
  //   (src: LR?)
  //   (trg: NIA?)
  struct bclr_branch___other__ : public branch___other__ {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.CR.can_alloc(uarch,ic,logger,"read")) return false;
      if (!uarch.CTR.can_alloc(uarch,ic,logger,"read")) return false;
      if (!uarch.LR.can_alloc(uarch,ic,logger,"read")) return false;
  ...
  static bclr_branch___other__ bclr_branch___other___v;
  ...
  struct Inst_branch : public Inst_P {
    ...
    typedef struct Inst_branch ThisClass;
    
    Inst_branch &thisInstr() { return *this; };
    
    branch___other__ &__other__;
    
    Inst_branch(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, branch___other__ &__other___p) : __other__(__other___p)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  struct lmv_Imm : public DummyOp {
    virtual unsigned mask(Inst_P &,unsigned = 0) const { return 0; }
    
    virtual unsigned value(OSM_P &,Inst_P &,Logger *) const { return 0; }
    
    using DummyOp::read;
  };
  
  static lmv_Imm lmv_Imm_v;
  
  struct lmv_Src : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static lmv_Src lmv_Src_v;
  
  struct lmv_Trg : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static lmv_Trg lmv_Trg_v;
  
  //
  // Operands for instruction class lmv
  //
  
  // Operands:
  //   (src: GPR(RA))
  struct e_lmvsprw_lmv_Src : public lmv_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static e_lmvsprw_lmv_Src e_lmvsprw_lmv_Src_v;
  ...
  //   (trg: LR)
  //   (trg: XER)
  struct e_lmvsprw_lmv_Trg : public lmv_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.CR.can_alloc(uarch,ic,logger,"read")) return false;
      if (!uarch.CTR.can_alloc(uarch,ic,logger,"read")) return false;
      if (!uarch.LR.can_alloc(uarch,ic,logger,"read")) return false;
      if (!uarch.XER.can_alloc(uarch,ic,logger,"read")) return false;
      return true;
    }
    ...
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger,unsigned sub_op) {
      switch (sub_op) {
        ...
        case 2: if (!uarch.LR.can_alloc(uarch,ic,logger,"read")) return false;
          return true;
        case 3: if (!uarch.XER.can_alloc(uarch,ic,logger,"read")) return false;
          return true;
      }
      assert(0);
      return 0;
    ...
    void allocate(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      ...
      uarch.CTR.allocate(uarch,ic,logger);
      uarch.LR.allocate(uarch,ic,logger);
      uarch.XER.allocate(uarch,ic,logger);
    }
    ...
    void deallocate(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      ...
      uarch.CTR.deallocate(uarch,ic,logger);
      uarch.LR.deallocate(uarch,ic,logger);
      uarch.XER.deallocate(uarch,ic,logger);
    }
    ...
    void write(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      ...
      ic._instr->commit(uarch.get_iss(),1);
      if (logger)logger->logOpAction("write",static_cast<OSM_P&>(uarch).CTR.name(),-1,ic._instr->slot(1).uint64());
      ic._instr->commit(uarch.get_iss(),3);
      if (logger)logger->logOpAction("write",static_cast<OSM_P&>(uarch).LR.name(),-1,ic._instr->slot(3).uint64());
      ic._instr->commit(uarch.get_iss(),4);
      if (logger)logger->logOpAction("write",static_cast<OSM_P&>(uarch).XER.name(),-1,ic._instr->slot(4).uint64());
    }
  ...
  static e_lmvsprw_lmv_Trg e_lmvsprw_lmv_Trg_v;
  
  //
  // Instruction class lmv
  //
  struct Inst_lmv : public Inst_P {
    
    typedef struct Inst_lmv ThisClass;
    
    Inst_lmv &thisInstr() { return *this; };
    
    lmv_Imm &Imm;
    lmv_Src &Src;
    lmv_Trg &Trg;
    
    Inst_lmv(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, lmv_Imm &Imm_p, lmv_Src &Src_p, lmv_Trg &Trg_p) : Imm(Imm_p), Src(Src_p), Trg(Trg_p)
    {
      reset(iid,cid,ic,instr);
    }
    ...
    bool can_read_ops(OSM_P &uarch,Inst_P &ic,Logger *logger)
    {
      return (Imm.can_read(uarch,ic,logger) && Src.can_read(uarch,ic,logger) && Trg.can_read(uarch,ic,logger));
    }
    
    bool can_write_ops(OSM_P &uarch,Inst_P &ic,Logger *logger)
    {
      return (Imm.can_write(uarch,ic,logger) && Src.can_write(uarch,ic,logger) && Trg.can_write(uarch,ic,logger));
    }
    
    void read_ops(OSM_P &uarch,Inst_P &ic,Logger *logger)
    {
      Imm.read(uarch,ic,logger);
    ...
    bool action_S_MMp(OSM_P &uarch,Logger *logger,unsigned position) {
      if ( exec_done (  ) && ! check_latency(logger) ) {
            decr_latency (  ) ;
      } else if ( exec_done (  ) && uarch.mWB.has_space(uarch,*this,logger) ) {
  ...
  struct load_Imm : public DummyOp {
    virtual bits<16> mask(Inst_P &,unsigned = 0) const { return 0; }
    
    virtual bits<16> value(OSM_P &,Inst_P &,Logger *) const { return 0; }
    
    using DummyOp::read;
  };
  
  static load_Imm load_Imm_v;
  
  struct load_Src : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static load_Src load_Src_v;
  
  struct load_Trg : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  // Operands:
  //   (imm: D)
  struct lbz_load_Imm : public load_Imm {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      return true;
    }
  ...
  static lbz_load_Imm lbz_load_Imm_v;
  
  // Operands:
  //   (src: GPR(RA))
  struct lbz_load_Src : public load_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static lbz_load_Src lbz_load_Src_v;
  
  // Operands:
  //   (trg: GPR(RT))
  struct lbz_load_Trg : public load_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static lwzu_load_Src lwzu_load_Src_v;
  
  // Operands:
  //   (trg: GPR(RA . uint32 (  )))
  //   (trg: GPR(RT))
  struct lwzu_load_Trg : public load_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
  ...
  static lwzu_load_Trg lwzu_load_Trg_v;
  
  // Operands:
  //   (src: GPR(RA))
  //   (src: GPR(RB))
  struct lwzx_load_Src : public load_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
  ...
  static lwzx_load_Src lwzx_load_Src_v;
  
  // Operands:
  //   (trg: GPR(RT))
  struct lwzx_load_Trg : public load_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(2)._index,"read")) return false;
      return true;
    }
  ...
  static lwzx_load_Trg lwzx_load_Trg_v;
  ...
  struct Inst_load : public Inst_P {
    ...
    typedef struct Inst_load ThisClass;
    ...
    Inst_load(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, load_Imm &Imm_p, load_Src &Src_p, load_Trg &Trg_p) : Imm(Imm_p), Src(Src_p), Trg(Trg_p)
    {
      reset(iid,cid,ic,instr);
    }
  ...
  struct mtspr_Src : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static mtspr_Src mtspr_Src_v;
  
  struct mtspr_Trg : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  // Operands:
  //   (src: GPR(RS))
  struct mtspr_mtspr_Src : public mtspr_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      return true;
    }
  ...
  static mtspr_mtspr_Src mtspr_mtspr_Src_v;
  
  // Operands:
  //   (trg: SPR(SPRN))
  struct mtspr_mtspr_Trg : public mtspr_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static mtspr_mtspr_Trg mtspr_mtspr_Trg_v;
  ...
  struct Inst_mtspr : public Inst_P {
    ...
    typedef struct Inst_mtspr ThisClass;
    ...
    Inst_mtspr(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, mtspr_Src &Src_p, mtspr_Trg &Trg_p) : Src(Src_p), Trg(Trg_p)
    {
      reset(iid,cid,ic,instr);
    }
    ...
    bool action_S_EX(OSM_P &uarch,Logger *logger,unsigned position) {
      {
            ...
            if ( Trg.field_value(uarch,*this,logger) == 50 || Trg.field_value(uarch,*this,logger) == 51 ) {
                  set_latency ( 2 ) ;
              }
    ...
    bool action_S_EXp(OSM_P &uarch,Logger *logger,unsigned position) {
      if ( check_latency(logger) && uarch.mMM.has_space(uarch,*this,logger) ) {
  ...
  struct mul_Src1 : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static mul_Src1 mul_Src1_v;
  
  struct mul_Src2 : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static mul_Src2 mul_Src2_v;
  
  struct mul_Trg : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static mul_Trg mul_Trg_v;
  
  //
  // Operands for instruction class mul
  //
  
  // Operands:
  //   (src: GPR(RA))
  struct mulli_mul_Src1 : public mul_Src1 {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      return true;
    }
  ...
  static mulli_mul_Src1 mulli_mul_Src1_v;
  
  // Operands:
  //   (trg: GPR(RT))
  struct mulli_mul_Trg : public mul_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
    }
  ...
  static mulli_mul_Trg mulli_mul_Trg_v;
  
  // Operand Alias:  mulli_mul_Src1 -> mullw_mul_Src1
  //   (src: GPR(RA))
  typedef mulli_mul_Src1 mullw_mul_Src1;
  
  static mullw_mul_Src1 mullw_mul_Src1_v;
  
  // Operands:
  //   (src: GPR(RB))
  struct mullw_mul_Src2 : public mul_Src2 {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
    }
  ...
  static mullw_mul_Src2 mullw_mul_Src2_v;
  
  // Operands:
  //   (trg: GPR(RT))
  struct mullw_mul_Trg : public mul_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(2)._index,"read")) return false;
      return true;
    }
  ...
  static mullw_mul_Trg mullw_mul_Trg_v;
  
  // Operand Alias:  mulli_mul_Src1 -> divw_mul_Src1
  //   (src: GPR(RA))
  typedef mulli_mul_Src1 divw_mul_Src1;
  
  static divw_mul_Src1 divw_mul_Src1_v;
  
  // Operand Alias:  mullw_mul_Src2 -> divw_mul_Src2
  //   (src: GPR(RB))
  typedef mullw_mul_Src2 divw_mul_Src2;
  
  static divw_mul_Src2 divw_mul_Src2_v;
  
  // Operand Alias:  mullw_mul_Trg -> divw_mul_Trg
  //   (trg: GPR(RT))
  typedef mullw_mul_Trg divw_mul_Trg;
  
  static divw_mul_Trg divw_mul_Trg_v;
  
  static OSM_P::mulli_mul_delay mulli_mul_delay_v;
  
  static OSM_P::mullw_mul_delay mullw_mul_delay_v;
  
  static OSM_P::divw_mul_delay divw_mul_delay_v;
  
  //
  // Instruction class mul
  //
  struct Inst_mul : public Inst_P {
    
    typedef struct Inst_mul ThisClass;
    
    Inst_mul &thisInstr() { return *this; };
    
    mul_Src1 &Src1;
    mul_Src2 &Src2;
    mul_Trg &Trg;
    OSM_P::mul_delay &delay;
    
    Inst_mul(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, mul_Src1 &Src1_p, mul_Src2 &Src2_p, mul_Trg &Trg_p, OSM_P::mul_delay &delay_p) : Src1(Src1_p), Src2(Src2_p), Trg(Trg_p), delay(delay_p)
    {
      reset(iid,cid,ic,instr);
    }
    ...
    bool can_read_ops(OSM_P &uarch,Inst_P &ic,Logger *logger)
    {
      return (Src1.can_read(uarch,ic,logger) && Src2.can_read(uarch,ic,logger) && Trg.can_read(uarch,ic,logger));
    }
    
    bool can_write_ops(OSM_P &uarch,Inst_P &ic,Logger *logger)
    {
      return (Src1.can_write(uarch,ic,logger) && Src2.can_write(uarch,ic,logger) && Trg.can_write(uarch,ic,logger));
    }
    
    void read_ops(OSM_P &uarch,Inst_P &ic,Logger *logger)
    {
      Src1.read(uarch,ic,logger);
      Src2.read(uarch,ic,logger);
      Trg.read(uarch,ic,logger);
    }
    
    void allocate_ops(OSM_P &uarch,Inst_P &ic,Logger *logger)
    {
      Src1.allocate(uarch,ic,logger);
      Src2.allocate(uarch,ic,logger);
      Trg.allocate(uarch,ic,logger);
    }
    ...
    // State action S_ID
    bool action_S_ID(OSM_P &uarch,Logger *logger,unsigned position) {
      if ( can_read_ops(uarch,*this,logger) && can_write_ops(uarch,*this,logger) && uarch.mEX.has_space(uarch,*this,logger) && uarch.MulFlag.can_allocate(uarch,*this,logger) ) {
            read_ops(uarch,*this,logger) ;
            allocate_ops(uarch,*this,logger) ;
            uarch.MulFlag.allocate(uarch,*this,logger) ;
            return change_state_S_ID__S_EX(uarch,logger,position) ;
      }
      return false;
    }
    ...
    bool action_S_WBp(OSM_P &uarch,Logger *logger,unsigned position) {
      {
            uarch.MulFlag.deallocate(uarch,*this,logger) ;
            return change_state_S_WBp__S_INIT(uarch,logger,position) ;
      }
      return false;
    }
  ...
  struct sfx_Flags : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static sfx_Flags sfx_Flags_v;
  
  struct sfx_Foo : public DummyOp {
    virtual unsigned mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static sfx_Foo sfx_Foo_v;
  
  struct sfx_Src1 : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static sfx_Src1 sfx_Src1_v;
  
  struct sfx_Src2 : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static sfx_Src2 sfx_Src2_v;
  
  struct sfx_Trg : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  struct addic__sfx_Flags : public sfx_Flags {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static addic__sfx_Flags addic__sfx_Flags_v;
  
  // Operands:
  //   (const: 1)
  struct addic__sfx_Foo : public sfx_Foo {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      return true;
    }
  ...
  static addic__sfx_Foo addic__sfx_Foo_v;
  
  // Operands:
  //   (src: GPR(RA))
  struct addic__sfx_Src1 : public sfx_Src1 {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
    }
  ...
  static addic__sfx_Src1 addic__sfx_Src1_v;
  
  // Operands:
  //   (trg: GPR(RT))
  struct addic__sfx_Trg : public sfx_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(2)._index,"read")) return false;
      return true;
    }
  ...
  static addic__sfx_Trg addic__sfx_Trg_v;
  
  // Operand Alias:  addic__sfx_Foo -> addi_sfx_Foo
  //   (const: 1)
  typedef addic__sfx_Foo addi_sfx_Foo;
  
  static addi_sfx_Foo addi_sfx_Foo_v;
  
  // Operands:
  //   (src: GPR(RA)?)
  struct addi_sfx_Src1 : public sfx_Src1 {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      return true;
    }
  ...
  static addi_sfx_Src1 addi_sfx_Src1_v;
  
  // Operands:
  //   (trg: GPR(RT))
  struct addi_sfx_Trg : public sfx_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
    }
  ...
  static addi_sfx_Trg addi_sfx_Trg_v;
  
  // Operand Alias:  addic__sfx_Foo -> addis_sfx_Foo
  //   (const: 1)
  typedef addic__sfx_Foo addis_sfx_Foo;
  
  static addis_sfx_Foo addis_sfx_Foo_v;
  
  // Operand Alias:  addi_sfx_Src1 -> addis_sfx_Src1
  //   (src: GPR(RA)?)
  typedef addi_sfx_Src1 addis_sfx_Src1;
  
  static addis_sfx_Src1 addis_sfx_Src1_v;
  
  // Operand Alias:  addi_sfx_Trg -> addis_sfx_Trg
  //   (trg: GPR(RT))
  typedef addi_sfx_Trg addis_sfx_Trg;
  
  static addis_sfx_Trg addis_sfx_Trg_v;
  
  // Operands:
  //   (const: 2)
  struct ori_sfx_Foo : public sfx_Foo {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      return true;
    }
  ...
  static ori_sfx_Foo ori_sfx_Foo_v;
  
  // Operands:
  //   (src: GPR(RS))
  struct ori_sfx_Src1 : public sfx_Src1 {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
    }
  ...
  static ori_sfx_Src1 ori_sfx_Src1_v;
  
  // Operands:
  //   (trg: GPR(RA))
  struct ori_sfx_Trg : public sfx_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      return true;
    }
  ...
  static ori_sfx_Trg ori_sfx_Trg_v;
  
  // Operands:
  //   (trg: CR[mask 0xf0000000]/p)
  //   (src: XER[mask 0x80000000]/p)
  struct andi__sfx_Flags : public sfx_Flags {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.CR.can_alloc(uarch,ic,logger,"read", ic._masks[0])) return false;
      if (!uarch.XER.can_alloc(uarch,ic,logger,"read", ic._masks[1])) return false;
      return true;
  ...
  static andi__sfx_Flags andi__sfx_Flags_v;
  
  // Operand Alias:  ori_sfx_Foo -> andi__sfx_Foo
  //   (const: 2)
  typedef ori_sfx_Foo andi__sfx_Foo;
  
  static andi__sfx_Foo andi__sfx_Foo_v;
  
  // Operands:
  //   (src: GPR(RS))
  struct andi__sfx_Src1 : public sfx_Src1 {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(2)._index,"read")) return false;
      return true;
    }
  ...
  static andi__sfx_Src1 andi__sfx_Src1_v;
  
  // Operands:
  //   (trg: GPR(RA))
  struct andi__sfx_Trg : public sfx_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
    }
  ...
  static andi__sfx_Trg andi__sfx_Trg_v;
  
  // Operand Alias:  addic__sfx_Foo -> add_sfx_Foo
  //   (const: 1)
  typedef addic__sfx_Foo add_sfx_Foo;
  
  static add_sfx_Foo add_sfx_Foo_v;
  
  // Operand Alias:  addi_sfx_Src1 -> add_sfx_Src1
  //   (src: GPR(RA))
  typedef addi_sfx_Src1 add_sfx_Src1;
  
  static add_sfx_Src1 add_sfx_Src1_v;
  
  // Operands:
  //   (src: GPR(RB))
  struct add_sfx_Src2 : public sfx_Src2 {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
    }
  ...
  static add_sfx_Src2 add_sfx_Src2_v;
  
  // Operand Alias:  addic__sfx_Trg -> add_sfx_Trg
  //   (trg: GPR(RT))
  typedef addic__sfx_Trg add_sfx_Trg;
  
  static add_sfx_Trg add_sfx_Trg_v;
  
  // Operand Alias:  ori_sfx_Foo -> or_sfx_Foo
  //   (const: 2)
  typedef ori_sfx_Foo or_sfx_Foo;
  
  static or_sfx_Foo or_sfx_Foo_v;
  
  // Operand Alias:  andi__sfx_Src1 -> or_sfx_Src1
  //   (src: GPR(RS))
  typedef andi__sfx_Src1 or_sfx_Src1;
  
  static or_sfx_Src1 or_sfx_Src1_v;
  
  // Operand Alias:  add_sfx_Src2 -> or_sfx_Src2
  //   (src: GPR(RB))
  typedef add_sfx_Src2 or_sfx_Src2;
  
  static or_sfx_Src2 or_sfx_Src2_v;
  
  // Operand Alias:  ori_sfx_Trg -> or_sfx_Trg
  //   (trg: GPR(RA))
  typedef ori_sfx_Trg or_sfx_Trg;
  
  static or_sfx_Trg or_sfx_Trg_v;
  
  // Operands:
  //   (src: XER[mask 0x80000000]/p)
  struct cmpi_sfx_Flags : public sfx_Flags {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static cmpi_sfx_Flags cmpi_sfx_Flags_v;
  
  // Operands:
  //   (const: 3)
  struct cmpi_sfx_Foo : public sfx_Foo {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      return true;
    }
  ...
  static cmpi_sfx_Foo cmpi_sfx_Foo_v;
  
  // Operand Alias:  addic__sfx_Src1 -> cmpi_sfx_Src1
  //   (src: GPR(RA))
  typedef addic__sfx_Src1 cmpi_sfx_Src1;
  
  static cmpi_sfx_Src1 cmpi_sfx_Src1_v;
  
  // Operands:
  //   (trg: CR/p)
  struct cmpi_sfx_Trg : public sfx_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.CR.can_alloc(uarch,ic,logger,"read")) return false;
      return true;
    }
  ...
  static cmpi_sfx_Trg cmpi_sfx_Trg_v;
  
  // Operands:
  //   (src: XER[mask 0x80000000]/p)
  struct cmp_sfx_Flags : public sfx_Flags {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static cmp_sfx_Flags cmp_sfx_Flags_v;
  
  // Operand Alias:  cmpi_sfx_Foo -> cmp_sfx_Foo
  //   (const: 3)
  typedef cmpi_sfx_Foo cmp_sfx_Foo;
  
  static cmp_sfx_Foo cmp_sfx_Foo_v;
  
  // Operand Alias:  addic__sfx_Src1 -> cmp_sfx_Src1
  //   (src: GPR(RA))
  typedef addic__sfx_Src1 cmp_sfx_Src1;
  
  static cmp_sfx_Src1 cmp_sfx_Src1_v;
  
  // Operands:
  //   (src: GPR(RB))
  struct cmp_sfx_Src2 : public sfx_Src2 {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(2)._index,"read")) return false;
      return true;
    }
  ...
  static cmp_sfx_Src2 cmp_sfx_Src2_v;
  
  // Operand Alias:  cmpi_sfx_Trg -> cmp_sfx_Trg
  //   (trg: CR/p)
  typedef cmpi_sfx_Trg cmp_sfx_Trg;
  
  static cmp_sfx_Trg cmp_sfx_Trg_v;
  
  // Operand Alias:  ori_sfx_Foo -> rlwinm_sfx_Foo
  //   (const: 2)
  typedef ori_sfx_Foo rlwinm_sfx_Foo;
  
  static rlwinm_sfx_Foo rlwinm_sfx_Foo_v;
  
  // Operand Alias:  ori_sfx_Src1 -> rlwinm_sfx_Src1
  //   (src: GPR(RS))
  typedef ori_sfx_Src1 rlwinm_sfx_Src1;
  
  static rlwinm_sfx_Src1 rlwinm_sfx_Src1_v;
  
  // Operand Alias:  ori_sfx_Trg -> rlwinm_sfx_Trg
  //   (trg: GPR(RA))
  typedef ori_sfx_Trg rlwinm_sfx_Trg;
  
  static rlwinm_sfx_Trg rlwinm_sfx_Trg_v;
  
  // Operands:
  //   (src: SPR(SPRN))
  struct mfspr_sfx_Src1 : public sfx_Src1 {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.SPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
    }
  ...
  static mfspr_sfx_Src1 mfspr_sfx_Src1_v;
  
  // Operands:
  //   (trg: GPR(RT))
  struct mfspr_sfx_Trg : public sfx_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      return true;
    }
  ...
  static mfspr_sfx_Trg mfspr_sfx_Trg_v;
  
  // Operand Alias:  ori_sfx_Foo -> srw_sfx_Foo
  //   (const: 2)
  typedef ori_sfx_Foo srw_sfx_Foo;
  
  static srw_sfx_Foo srw_sfx_Foo_v;
  
  // Operand Alias:  andi__sfx_Src1 -> srw_sfx_Src1
  //   (src: GPR(RS))
  typedef andi__sfx_Src1 srw_sfx_Src1;
  
  static srw_sfx_Src1 srw_sfx_Src1_v;
  
  // Operands:
  //   (src: GPR(RB)[mask 0x0000001f]/p)
  struct srw_sfx_Src2 : public sfx_Src2 {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
  ...
  static srw_sfx_Src2 srw_sfx_Src2_v;
  
  // Operand Alias:  ori_sfx_Trg -> srw_sfx_Trg
  //   (trg: GPR(RA))
  typedef ori_sfx_Trg srw_sfx_Trg;
  
  static srw_sfx_Trg srw_sfx_Trg_v;
  
  // Operand Alias:  addic__sfx_Foo -> halt_sfx_Foo
  //   (const: 1)
  typedef addic__sfx_Foo halt_sfx_Foo;
  
  static halt_sfx_Foo halt_sfx_Foo_v;
  ...
  struct Inst_sfx : public Inst_P {
    ...
    typedef struct Inst_sfx ThisClass;
    ...
    Inst_sfx(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, sfx_Flags &Flags_p, sfx_Foo &Foo_p, sfx_Src1 &Src1_p, sfx_Src2 &Src2_p, sfx_Trg &Trg_p) : Flags(Flags_p), Foo(Foo_p), Src1(Src1_p), Src2(Src2_p), Trg(Trg_p)
    {
      reset(iid,cid,ic,instr);
    }
    ...
    void deallocate_ops(OSM_P &uarch,Inst_P &ic,Logger *logger)
    {
      ...
      Foo.deallocate(uarch,ic,logger);
      Src1.deallocate(uarch,ic,logger);
      Src2.deallocate(uarch,ic,logger);
      Trg.deallocate(uarch,ic,logger);
    }
    ...
    // State action S_ID
    bool action_S_ID(OSM_P &uarch,Logger *logger,unsigned position) {
      if ( Src1.can_read(uarch,*this,logger) && Src2.can_read(uarch,*this,logger) && Flags.can_read(uarch,*this,logger) && Trg.can_write(uarch,*this,logger) && uarch.mEX.has_space(uarch,*this,logger) && Foo.value(uarch,*this,logger) ) {
  ...
  struct store_Src : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  static store_Src store_Src_v;
  
  struct store_Trg : public DummyOp {
    virtual bits<32> mask(Inst_P &,unsigned = 0) const { return 0; }
  ...
  //   (src: GPR(RA))
  //   (src: GPR(RS))
  struct stb_store_Src : public store_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      return true;
  ...
  static stb_store_Src stb_store_Src_v;
  ...
  static sth_store_Src sth_store_Src_v;
  
  // Operands:
  //   (src: GPR(RA))
  //   (src: GPR(RB))
  //   (src: GPR(RS))
  struct sthx_store_Src : public store_Src {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(1)._index,"read")) return false;
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(2)._index,"read")) return false;
  ...
  static sthx_store_Src sthx_store_Src_v;
  ...
  static stw_store_Src stw_store_Src_v;
  ...
  static stwu_store_Src stwu_store_Src_v;
  
  // Operands:
  //   (trg: GPR(RA))
  struct stwu_store_Trg : public store_Trg {
    bool can_read(OSM_P &uarch,Inst_P &ic,Logger *logger) {
      if (!uarch.GPR.can_alloc(uarch,ic,logger,ic.op(0)._index,"read")) return false;
      return true;
    }
  ...
  static stwu_store_Trg stwu_store_Trg_v;
  ...
  static stwx_store_Src stwx_store_Src_v;
  ...
  struct Inst_store : public Inst_P {
    ...
    typedef struct Inst_store ThisClass;
    ...
    Inst_store(unsigned iid,unsigned cid,unsigned ic,InstrPacket *instr, store_Src &Src_p, store_Trg &Trg_p) : Src(Src_p), Trg(Trg_p)
    {
      reset(iid,cid,ic,instr);
    }
    ...
    bool action_S_EX(OSM_P &uarch,Logger *logger,unsigned position) {
      if ( uarch.mMM.has_space(uarch,*this,logger) && uarch.mMEM.can_request_write(uarch,*this,logger) ) {
            uarch.exec_mem_mEX(*this,logger,position) ;
  ...
  //
   ...
   int OSM_P:: div_delay ( int y ) {
         bits < 16 > tmp = 0x8000 ;
         AdlTypeof( tmp.signExtend<32>() ) foo = tmp.signExtend<32>() ;
        return 5 ;
  }
  
   int OSM_P:: mull_delay ( int x ) {
        return 0 ;
  }
  ...
  Inst_P *OSM_P::get_instr_add(void *x)
  {
    ...
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,sfx_Flags_v,add_sfx_Foo_v,add_sfx_Src1_v,add_sfx_Src2_v,add_sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,sfx_Flags_v,addi_sfx_Foo_v,addi_sfx_Src1_v,sfx_Src2_v,addi_sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,addic__sfx_Flags_v,addic__sfx_Foo_v,addic__sfx_Src1_v,sfx_Src2_v,addic__sfx_Trg_v);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,sfx_Flags_v,addis_sfx_Foo_v,addis_sfx_Src1_v,sfx_Src2_v,addis_sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,andi__sfx_Flags_v,andi__sfx_Foo_v,andi__sfx_Src1_v,sfx_Src2_v,andi__sfx_Trg_v);
    ic->_masks[0] = 0xf0000000;
    ic->_masks[1] = 0x80000000;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch *ic = new (_instr_pool.alloc()) Inst_branch(_issueId++,_commits,adliss::P::branchClass,p,b_branch___other___v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch *ic = new (_instr_pool.alloc()) Inst_branch(_issueId++,_commits,adliss::P::branchClass,p,bc_branch___other___v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch *ic = new (_instr_pool.alloc()) Inst_branch(_issueId++,_commits,adliss::P::branchClass,p,bclr_branch___other___v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_branch *ic = new (_instr_pool.alloc()) Inst_branch(_issueId++,_commits,adliss::P::branchClass,p,bl_branch___other___v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,cmp_sfx_Flags_v,cmp_sfx_Foo_v,cmp_sfx_Src1_v,cmp_sfx_Src2_v,cmp_sfx_Trg_v);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,cmpi_sfx_Flags_v,cmpi_sfx_Foo_v,cmpi_sfx_Src1_v,sfx_Src2_v,cmpi_sfx_Trg_v);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_mul *ic = new (_instr_pool.alloc()) Inst_mul(_issueId++,_commits,adliss::P::mulClass,p,divw_mul_Src1_v,divw_mul_Src2_v,divw_mul_Trg_v,divw_mul_delay_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    throw unimpl_instr_exception("Instruction 'get_instr_divw_' is not implemented in this model.");
  }
  
  // Factory function for instruction "e_lmvsprw".
  Inst_P *OSM_P::get_instr_e_lmvsprw(void *x)
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_lmv *ic = new (_instr_pool.alloc()) Inst_lmv(_issueId++,_commits,adliss::P::lmvClass,p,lmv_Imm_v,e_lmvsprw_lmv_Src_v,e_lmvsprw_lmv_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,sfx_Flags_v,halt_sfx_Foo_v,sfx_Src1_v,sfx_Src2_v,sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load *ic = new (_instr_pool.alloc()) Inst_load(_issueId++,_commits,adliss::P::loadClass,p,lbz_load_Imm_v,lbz_load_Src_v,lbz_load_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load *ic = new (_instr_pool.alloc()) Inst_load(_issueId++,_commits,adliss::P::loadClass,p,lhz_load_Imm_v,lhz_load_Src_v,lhz_load_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load *ic = new (_instr_pool.alloc()) Inst_load(_issueId++,_commits,adliss::P::loadClass,p,lwz_load_Imm_v,lwz_load_Src_v,lwz_load_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load *ic = new (_instr_pool.alloc()) Inst_load(_issueId++,_commits,adliss::P::loadClass,p,lwzu_load_Imm_v,lwzu_load_Src_v,lwzu_load_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_load *ic = new (_instr_pool.alloc()) Inst_load(_issueId++,_commits,adliss::P::loadClass,p,load_Imm_v,lwzx_load_Src_v,lwzx_load_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,sfx_Flags_v,sfx_Foo_v,mfspr_sfx_Src1_v,sfx_Src2_v,mfspr_sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_mtspr *ic = new (_instr_pool.alloc()) Inst_mtspr(_issueId++,_commits,adliss::P::mtsprClass,p,mtspr_mtspr_Src_v,mtspr_mtspr_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_mul *ic = new (_instr_pool.alloc()) Inst_mul(_issueId++,_commits,adliss::P::mulClass,p,mulli_mul_Src1_v,mul_Src2_v,mulli_mul_Trg_v,mulli_mul_delay_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_mul *ic = new (_instr_pool.alloc()) Inst_mul(_issueId++,_commits,adliss::P::mulClass,p,mullw_mul_Src1_v,mullw_mul_Src2_v,mullw_mul_Trg_v,mullw_mul_delay_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,sfx_Flags_v,or_sfx_Foo_v,or_sfx_Src1_v,or_sfx_Src2_v,or_sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,sfx_Flags_v,ori_sfx_Foo_v,ori_sfx_Src1_v,sfx_Src2_v,ori_sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,sfx_Flags_v,rlwinm_sfx_Foo_v,rlwinm_sfx_Src1_v,sfx_Src2_v,rlwinm_sfx_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx *ic = new (_instr_pool.alloc()) Inst_sfx(_issueId++,_commits,adliss::P::sfxClass,p,sfx_Flags_v,srw_sfx_Foo_v,srw_sfx_Src1_v,srw_sfx_Src2_v,srw_sfx_Trg_v);
    ic->_masks[2] = 0x1f;
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store *ic = new (_instr_pool.alloc()) Inst_store(_issueId++,_commits,adliss::P::storeClass,p,stb_store_Src_v,store_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store *ic = new (_instr_pool.alloc()) Inst_store(_issueId++,_commits,adliss::P::storeClass,p,sth_store_Src_v,store_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store *ic = new (_instr_pool.alloc()) Inst_store(_issueId++,_commits,adliss::P::storeClass,p,sthx_store_Src_v,store_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store *ic = new (_instr_pool.alloc()) Inst_store(_issueId++,_commits,adliss::P::storeClass,p,stw_store_Src_v,store_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store *ic = new (_instr_pool.alloc()) Inst_store(_issueId++,_commits,adliss::P::storeClass,p,stwu_store_Src_v,stwu_store_Trg_v);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_store *ic = new (_instr_pool.alloc()) Inst_store(_issueId++,_commits,adliss::P::storeClass,p,stwx_store_Src_v,store_Trg_v);
    return ic;
  }
  ...
  void OSM_P::flush_issue_stage(Logger *logger,unsigned position,bool given_addr,addr_t addr)
  {
    if (!Issue.empty()) {
      ...
      if (!instr->is_fetch_exception()) IF.removeInstr(instr->_instr->size());
      Issue.remove_instr();
      discard(instr);
    }
  ...
  void OSM_P::flush_issue(Logger *logger,bool given_addr,addr_t addr)
  {
    ...
    IF.flush((given_addr) ? addr : get_pc());
    ++_flushCount;
  }
  ...
  Inst_P *OSM_P::issueInstruction()
  {
    ...
    if (FetchData fd = IF.instrData(_iss->tracing_on())) {
      instr = _iss->decode(fd._ea, fd._data, 0, fd._size, *this);
      IF.decodeUpdate(instr, instr ? instr->size() : 0);
      if (!instr) return 0;
    } else if (!IF.empty()) {
      return 0;
    }
  ...
  void OSM_P::update_tracing()
  {
    ...
    if (logFetch()) {
      IF.createLogger(_logclient,tflags);
    } else {
      IF.removeLogger();
    }
    if (logPipeline()) {
  ...
  {
    if (_iss->activeCount()) IF.sendFetchRequests();
    mMEM_obj.postCycle();
    _iss->post_cycle_handler();
  ...
  LR("LR"), 
  NIA("NIA"), 
  POST_CYCLE_COUNT("POST_CYCLE_COUNT"), 
  PRE_CYCLE_COUNT("PRE_CYCLE_COUNT"), 
  XER("XER"), 
  MulFlag("MulFlag",1), 
  IF(*this,getPath(_iss,".")+"IF",6,mMEM_obj,0,_fetchSizes,&mMEM_obj), 
  _cur_instr(0), 
  _ignore_mem(false), 
  Issue("    "), 
  _stall(false), 
  ...
  void OSM_P::reset()
  {
    ...
    LR.reset();
    NIA.reset();
    POST_CYCLE_COUNT.reset();
    PRE_CYCLE_COUNT.reset();
    XER.reset();
    MulFlag.reset();
    IF.full_reset();
    _cur_instr = 0;
  ...
  unsigned OSM_P::fetchStalls() const { return IF.fetchStalls(); }
