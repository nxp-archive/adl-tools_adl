...
namespace uadl {
  ...
  struct Inst_lmv : public Inst_P {
    ...
    typedef struct Inst_lmv<Imm_t, Src_t, Trg_t> ThisClass;
  ...
  //
  template <class Src1_t, class Src2_t, class Trg_t, class delay_t>
  struct Inst_mul : public Inst_P {
    
    typedef struct Inst_mul<Src1_t, Src2_t, Trg_t, delay_t> ThisClass;
  ...
  //
  template <class Flags_t, class Foo_t, class Src1_t, class Src2_t, class Trg_t>
  struct Inst_sfx : public Inst_P {
    
    typedef struct Inst_sfx<Flags_t, Foo_t, Src1_t, Src2_t, Trg_t> ThisClass;
  ...
  Inst_P *OSM_P::get_instr_add(void *x)
  {
    ...
    Inst_sfx<DummyOp, add_sfx_Foo, add_sfx_Src1, add_sfx_Src2, add_sfx_Trg> *ic = (Inst_sfx<DummyOp, add_sfx_Foo, add_sfx_Src1, add_sfx_Src2, add_sfx_Trg>*)_instr_pool.alloc();
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, addi_sfx_Foo, addi_sfx_Src1, DummyOp, addi_sfx_Trg> *ic = (Inst_sfx<DummyOp, addi_sfx_Foo, addi_sfx_Src1, DummyOp, addi_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<addic__sfx_Flags, addic__sfx_Foo, addic__sfx_Src1, DummyOp, addic__sfx_Trg> *ic = (Inst_sfx<addic__sfx_Flags, addic__sfx_Foo, addic__sfx_Src1, DummyOp, addic__sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, addis_sfx_Foo, addis_sfx_Src1, DummyOp, addis_sfx_Trg> *ic = (Inst_sfx<DummyOp, addis_sfx_Foo, addis_sfx_Src1, DummyOp, addis_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<andi__sfx_Flags, andi__sfx_Foo, andi__sfx_Src1, DummyOp, andi__sfx_Trg> *ic = (Inst_sfx<andi__sfx_Flags, andi__sfx_Foo, andi__sfx_Src1, DummyOp, andi__sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    ic->_masks[0] = 0xf0000000;
    ic->_masks[1] = 0x80000000;
    return ic;
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<cmp_sfx_Flags, cmp_sfx_Foo, cmp_sfx_Src1, cmp_sfx_Src2, cmp_sfx_Trg> *ic = (Inst_sfx<cmp_sfx_Flags, cmp_sfx_Foo, cmp_sfx_Src1, cmp_sfx_Src2, cmp_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<cmpi_sfx_Flags, cmpi_sfx_Foo, cmpi_sfx_Src1, DummyOp, cmpi_sfx_Trg> *ic = (Inst_sfx<cmpi_sfx_Flags, cmpi_sfx_Foo, cmpi_sfx_Src1, DummyOp, cmpi_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_mul<divw_mul_Src1, divw_mul_Src2, divw_mul_Trg, divw_mul_delay> *ic = (Inst_mul<divw_mul_Src1, divw_mul_Src2, divw_mul_Trg, divw_mul_delay>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::mulClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_lmv<DummyOp, e_lmvsprw_lmv_Src, e_lmvsprw_lmv_Trg> *ic = (Inst_lmv<DummyOp, e_lmvsprw_lmv_Src, e_lmvsprw_lmv_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::lmvClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, halt_sfx_Foo, DummyOp, DummyOp, DummyOp> *ic = (Inst_sfx<DummyOp, halt_sfx_Foo, DummyOp, DummyOp, DummyOp>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, DummyOp, mfspr_sfx_Src1, DummyOp, mfspr_sfx_Trg> *ic = (Inst_sfx<DummyOp, DummyOp, mfspr_sfx_Src1, DummyOp, mfspr_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_mul<mulli_mul_Src1, DummyOp, mulli_mul_Trg, mulli_mul_delay> *ic = (Inst_mul<mulli_mul_Src1, DummyOp, mulli_mul_Trg, mulli_mul_delay>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::mulClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_mul<mullw_mul_Src1, mullw_mul_Src2, mullw_mul_Trg, mullw_mul_delay> *ic = (Inst_mul<mullw_mul_Src1, mullw_mul_Src2, mullw_mul_Trg, mullw_mul_delay>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::mulClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, or_sfx_Foo, or_sfx_Src1, or_sfx_Src2, or_sfx_Trg> *ic = (Inst_sfx<DummyOp, or_sfx_Foo, or_sfx_Src1, or_sfx_Src2, or_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, ori_sfx_Foo, ori_sfx_Src1, DummyOp, ori_sfx_Trg> *ic = (Inst_sfx<DummyOp, ori_sfx_Foo, ori_sfx_Src1, DummyOp, ori_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, rlwinm_sfx_Foo, rlwinm_sfx_Src1, DummyOp, rlwinm_sfx_Trg> *ic = (Inst_sfx<DummyOp, rlwinm_sfx_Foo, rlwinm_sfx_Src1, DummyOp, rlwinm_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    return ic;
  }
  ...
  {
    InstrPacket *p ATTRIBUTE_UNUSED = (InstrPacket*)(x);
    Inst_sfx<DummyOp, srw_sfx_Foo, srw_sfx_Src1, srw_sfx_Src2, srw_sfx_Trg> *ic = (Inst_sfx<DummyOp, srw_sfx_Foo, srw_sfx_Src1, srw_sfx_Src2, srw_sfx_Trg>*)_instr_pool.alloc();
    ic->reset(_issueId++,_commits,adliss::P::sfxClass,p);
    ic->_masks[2] = 0x1f;
    return ic;
  }
