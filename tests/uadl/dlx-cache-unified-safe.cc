...
#  define ADL_HEADER
#endif
#include "dlx-cache-unified-safe-iss.cc"
#define _OSM_P_IMPLEMENTATION_H
#include "dlx-cache-unified-safe.h"
...
namespace uadl {
  ...
  void OSM_P::handle_memory_request(unsigned memId,const adl::MemAccess &m)
  {
    ...
    hint->_storeBufEnabled = L1_obj.storeBufEnabled();
    ma->reset(_memId++,m);
  ...
  {
    return _iss->L1_cache_enabled(adl::CacheIFetch,addr);
  }
