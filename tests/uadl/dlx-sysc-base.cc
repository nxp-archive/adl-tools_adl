...
#  define ADL_HEADER
#endif
#include "dlx-sysc-base-iss.cc"
#define _OSM_P_IMPLEMENTATION_H
#include "dlx-sysc-base.h"

using namespace std;
using namespace adl;
using namespace dlx_iss;




void dlx_iss::P::synchronizeActivation()
{
  _uarch->force_reset_fetch();
}

uint32_t dlx_iss::P::getMemoryData32(CacheAccess type, addr_t addr)
{
...
void dlx_iss::P::handle_memory_request(unsigned memId, const adl::MemAccess &ma) {
...
namespace dlx {
  ...
  Inst_P *OSM_P::get_instr_add(void *x)
  {
    ...
    ic->reset(_issueId++,_commits,dlx_iss::P::sfxClass,p);
    return ic;
  }
  ...
  Inst_P *OSM_P::get_instr_b(void *x)
  {
    ...
    ic->reset(_issueId++,_commits,dlx_iss::P::branchClass,p);
    return ic;
  }
  ...
  Inst_P *OSM_P::get_instr_lbz(void *x)
  {
    ...
    ic->reset(_issueId++,_commits,dlx_iss::P::loadClass,p);
    return ic;
  }
  ...
  Inst_P *OSM_P::get_instr_mtspr(void *x)
  {
    ...
    ic->reset(_issueId++,_commits,dlx_iss::P::mtsprClass,p);
    return ic;
  }
  ...
  Inst_P *OSM_P::get_instr_mulli(void *x)
  {
    ...
    ic->reset(_issueId++,_commits,dlx_iss::P::mulClass,p);
    return ic;
  }
  ...
  Inst_P *OSM_P::get_instr_stb(void *x)
  {
    ...
    ic->reset(_issueId++,_commits,dlx_iss::P::storeClass,p);
    return ic;
  }
